...
Public Class ParameterUI
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("AutoStationGapFiller", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("AutoStationGapFiller", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("AutoStationGapFiller", "ErrorCode")
        PostTest_ErrorCode.Name = "PostTest_ErrorCode"
        MachineListView_ErrorCode_Value.Columns.Add(PostTest_ErrorCode)

        For Each eType As enumGapFillerErrorType In [Enum].GetValues(GetType(enumGapFillerErrorType))
        ...
        PostTest_name.HeaderText = cLanguageManager.GetUserTextLine("AutoStationGapFiller", "Name")
        ...
        PostTest_value.HeaderText = cLanguageManager.GetUserTextLine("AutoStationGapFiller", "Device")
        PostTest_value.Name = "PostTest_value"
        MachineListView_Device_Value.Columns.Add(PostTest_value)

        TabPage1.Text = cLanguageManager.GetUserTextLine("AutoStationGapFiller", "TabPage1")
        TabPage2.Text = cLanguageManager.GetUserTextLine("AutoStationGapFiller", "TabPage2")
