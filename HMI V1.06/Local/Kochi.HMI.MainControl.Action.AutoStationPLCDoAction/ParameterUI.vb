...
Public Class ParameterUI
    ...
    Public Function CheckParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IParameterUI.CheckParameter
        If lListParameter.Count >= 2 AndAlso lListParameter(1) <> "" Then
            ...
            For i = 0 To cValueType.Count - 1
                ...
                If cValue(0) = "" Then
                    Throw New clsHMIException(cLanguageManager.GetUserTextLine("AutoStationPlcDoAction", "5"), enumExceptionType.Alarm)
                End If
            Next
        End If
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("AutoStationPlcDoAction", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("AutoStationPlcDoAction", "ErrorCode")
        ...
        PostTest_Name.HeaderText = cLanguageManager.GetUserTextLine("AutoStationPlcDoAction", "Name")
        PostTest_Name.Name = "PostTest_name"
        PostTest_Name.ReadOnly = False
        MachineListView_Type_Value.Columns.Add(PostTest_Name)

        TabPage1.Text = cLanguageManager.GetUserTextLine("AutoStationPlcDoAction", "TabPage1")
        TabPage2.Text = cLanguageManager.GetUserTextLine("AutoStationPlcDoAction", "TabPage2")
