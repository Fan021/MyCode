...
Public Class ParameterUI
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScan", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScan", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScan", "ErrorCode")
        ...
        PostTest_name.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScan", "Name")
        ...
        PostTest_value.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScan", "Device")
        PostTest_value.Name = "PostTest_value"
        MachineListView_Device_Value.Columns.Add(PostTest_value)

        TabPage1.Text = cLanguageManager.GetUserTextLine("AutoStationScan", "TabPage1")
        TabPage2.Text = cLanguageManager.GetUserTextLine("AutoStationScan", "TabPage2")
