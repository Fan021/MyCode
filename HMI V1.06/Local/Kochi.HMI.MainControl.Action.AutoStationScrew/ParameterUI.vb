...
Public Class ParameterUI
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScrew", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScrew", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScrew", "ErrorCode")
        ...
        PostTest_name.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScrew", "Name")
        ...
        PostTest_value.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScrew", "Device")
        ...
        PostTest_ParameterType.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScrew", "ParameterType")
        ...
        PostTest_ParameterValue.HeaderText = cLanguageManager.GetUserTextLine("AutoStationScrew", "ParameterValue")
        ...
        For Each eType As enumMESParameter In [Enum].GetValues(GetType(enumMESParameter))
            MachineListView_Parameter_Value.Rows.Add(MachineListView_Parameter_Value.Rows.Count + 1, cLanguageManager.GetUserTextLine("AutoStationScrew", eType.ToString), "")
        Next

        TabPage1.Text = cLanguageManager.GetUserTextLine("AutoStationScrew", "TabPage1")
        TabPage2.Text = cLanguageManager.GetUserTextLine("AutoStationScrew", "TabPage2")
        TabPage3.Text = cLanguageManager.GetUserTextLine("AutoStationScrew", "TabPage3")
