...
<clsHMIActionName("AutoStationScrew", enumHMIActionType.Auto, enumHMISubActionType.SubAction)>
Public Class clsScrewAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
        ...
        Dim strDevice As String = cMachineManager.ActionParameterManager.GetActionParameterDevice("AutoStationScrew", cMachineStationCfg.ID, 1)
            ...
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    Case 0
                        ...
                        End If
                    Case 1
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationScrew", "42", GetMessage(cSubStepCfg))))
                    ...
                    Case 2
                        ...
                        If cPLCAction.HmiAutoAction.bulPlcDoAction1 Then
                            cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationScrew", "33", GetMessage(cSubStepCfg))))
                            i.StepInputNumber = i.StepInputNumber + 1
                            Continue Do
                        End If
                        If cPLCAction.HmiAutoAction.bulPlcActionIsPass Then
                            i.StepInputNumber = i.StepInputNumber + 1
                            Continue Do
                        End If

                        If cPLCAction.HmiAutoAction.bulPlcActionIsFail Then
                            i.StepInputNumber = i.StepInputNumber + 1
                            Continue Do
                        End If
                    ...
                    Case 3
                        ...
                        If cPLCAction.HmiAutoAction.bulPlcDoAction2 Then
                            cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationScrew", "34", GetMessage(cSubStepCfg))))
                            i.StepInputNumber = i.StepInputNumber + 1
                            Continue Do
                        End If
                    ...
                    Case 7
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationScrew", "44", GetMessage(cSubStepCfg), cRunActionCfg.Message), enumMainTipsManagerType.Confirm))
                        i.StepInputNumber = i.StepOutputNumber + 1
                    ...
                    Case 8
                        ...
                        If cMainTipsManager.GetMainTipsConfirmTypeFromKey(cRunnerCfg.StationName) = enumMainTipsConfirmType.Abort Then
                            ...
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationScrew", "44", GetMessage(cSubStepCfg), cRunActionCfg.Message)
                            ...
                            cActionResultCfg.MESPosition = lListParameter(8).ToString
                            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("AutoStationScrew", cActionResultCfg.ErrorType, 0)
                            cActionShowManager.UpdateLastActionStepValue(cActionResultCfg.ErrorMessage)
                    ...
                    Case 10
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationScrew", "37", GetMessage(cSubStepCfg))))
                        For k = 0 To 16
                            If cPLCAction.ListParmeter(k) = "" Then
                                cPLCAction.ListParmeter(k) = "0"
                            End If
                        Next
                        cTempASTCfg = New clsASTCfg
                        cTempASTCfg.SysStatus = cPLCAction.ListParmeter(0)
                        cTempASTCfg.fdProg = cPLCAction.ListParmeter(1)
                        cTempASTCfg.fdStatus = cPLCAction.ListParmeter(2)
                        cTempASTCfg.fdTime = cPLCAction.ListParmeter(3)

                        cTempASTCfg.fdStep1 = cPLCAction.ListParmeter(4)
                        cTempASTCfg.fdTorque1 = cPLCAction.ListParmeter(5)
                        cTempASTCfg.fdAngle1 = cPLCAction.ListParmeter(6)

                        cTempASTCfg.fdStep2 = cPLCAction.ListParmeter(7)
                        cTempASTCfg.fdTorque2 = cPLCAction.ListParmeter(8)
                        cTempASTCfg.fdAngle2 = cPLCAction.ListParmeter(9)

                        cTempASTCfg.fdStep3 = cPLCAction.ListParmeter(10)
                        cTempASTCfg.fdTorque3 = cPLCAction.ListParmeter(11)
                        cTempASTCfg.fdAngle3 = cPLCAction.ListParmeter(12)

                        cTempASTCfg.fdStepNOk = cPLCAction.ListParmeter(13)
                        cTempASTCfg.fdTorqueNOk = cPLCAction.ListParmeter(14)
                        cTempASTCfg.fdAngleNOk = cPLCAction.ListParmeter(15)
                        cTempASTCfg.strTorqueUnit = cPLCAction.ListParmeter(16)
                    ...
                    Case 11
                        ...
                        If cASTCfg.fdStatus = 0 Then
                            strComment = cLanguageManager.GetUserTextLine("AutoStationScrew", "OK")
                        Else
                    ...
                    Case 14
                        ...
                        If IsNothing(cDeviceCfg) Then
                            cActionResultCfg.Result = False
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationScrew", "40", GetMessage(cSubStepCfg), strDeviceIndex)
                            cActionResultCfg.ErrorType = enumScrewErrorType.UnKnownError.ToString
                            cActionResultCfg.MainErrorType = enumMainScrewErrorType.ScrewError.ToString
                            cActionResultCfg.MESPosition = lListParameter(8).ToString
                            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("AutoStationScrew", cActionResultCfg.ErrorType, 0)
                    ...
                    Case 16
                        ...
                        strUnit = cLanguageManager.GetUserTextLine("AutoStationScrew", "AngleUnit")
                    ...
                    Case 21
                        ...
                        If IsNothing(cDeviceCfg) Then
                            cActionResultCfg.Result = False
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationScrew", "49", GetMessage(cSubStepCfg), strDeviceIndex)
                            cActionResultCfg.ErrorType = enumScrewErrorType.UnKnownError.ToString
                            cActionResultCfg.MainErrorType = enumMainScrewErrorType.ScrewError.ToString
                            cActionResultCfg.MESPosition = lListParameter(8).ToString
                            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("AutoStationScrew", cActionResultCfg.ErrorType, 0)
                    ...
                    Case 22
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationScrew", "43", GetMessage(cSubStepCfg))))
                        ...
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.MATERIAL.ToString), 2)
                        clogParameterCfg.Value = cMachineStatusCfg.VariantCfg.Variant
                        clogParameterCfg.DataType = "TEXT"
                        lListlogParameter.Add(clogParameterCfg)
                        'SFC
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.SFC.ToString), 2)
                        clogParameterCfg.Value = cMachineStatusCfg.VariantCfg.SFC
                        clogParameterCfg.DataType = "TEXT"
                        lListlogParameter.Add(clogParameterCfg)
                        'Material_HU
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.Material_HU.ToString), 2)
                        clogParameterCfg.Value = cSubStepCfg.ChangedSubStepParameter(HMISubStepKeys.Component, cLocalElement)
                        clogParameterCfg.DataType = "TEXT"
                        lListlogParameter.Add(clogParameterCfg)
                        'Control_HU
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.Control_HU.ToString), 2)
                        clogParameterCfg.Value = lListParameter(1)
                        clogParameterCfg.DataType = "TEXT"
                        lListlogParameter.Add(clogParameterCfg)
                        'TS
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.TS.ToString), 2)
                        clogParameterCfg.Value = cSubStepCfg.SubStepParameter(HMISubStepKeys.ID)
                        clogParameterCfg.DataType = "TEXT"
                        lListlogParameter.Add(clogParameterCfg)
                        'RECIPE
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.RECIPE.ToString), 2)
                        clogParameterCfg.Value = lListParameter(2)
                        clogParameterCfg.DataType = "TEXT"
                        lListlogParameter.Add(clogParameterCfg)
                        'STATUS
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STATUS.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdStatus.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'TIMESTAMP
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.TIMESTAMP.ToString), 2)
                        clogParameterCfg.Value = Now.ToString("yyyy-MM-dd HH:mm:ss")
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEPID
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEPID.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdStep.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP1_TORQUE_LL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP1_TORQUE_LL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueLow1.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP1_TORQUE_UL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP1_TORQUE_UL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueUp1.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP1_TORQUE_TAR_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP1_TORQUE_TAR_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueTarget1.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP1_TORQUE_MEA_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP1_TORQUE_MEA_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorque1.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP1_ANGLE_LL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP1_ANGLE_LL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleLow1.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP1_ANGLE_UL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP1_ANGLE_UL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleUp1.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP1_ANGLE_TAR_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP1_ANGLE_TAR_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleTarget1.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP1_ANGLE_MEA_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP1_ANGLE_MEA_VAL.ToString), 2)
                        ...
                        'STEP2_TORQUE_LL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP2_TORQUE_LL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueLow2.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP2_TORQUE_UL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP2_TORQUE_UL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueUp2.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP2_TORQUE_TAR_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP2_TORQUE_TAR_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueTarget2.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP2_TORQUE_MEA_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP2_TORQUE_MEA_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorque2.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP2_ANGLE_LL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP2_ANGLE_LL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleLow2.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP2_ANGLE_UL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP2_ANGLE_UL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleUp2.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP2_ANGLE_TAR_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP2_ANGLE_TAR_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleTarget2.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP2_ANGLE_MEA_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP2_ANGLE_MEA_VAL.ToString), 2)
                        ...
                        'STEP3_TORQUE_LL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP3_TORQUE_LL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueLow3.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP3_TORQUE_UL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP3_TORQUE_UL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueUp3.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP3_TORQUE_TAR_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP3_TORQUE_TAR_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorqueTarget3.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP3_TORQUE_MEA_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP3_TORQUE_MEA_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdTorque3.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP3_ANGLE_LL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP3_ANGLE_LL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleLow3.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP3_ANGLE_UL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP3_ANGLE_UL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleUp3.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP3_ANGLE_TAR_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP3_ANGLE_TAR_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngleTarget3.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'STEP3_ANGLE_MEA_VAL
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.STEP3_ANGLE_MEA_VAL.ToString), 2)
                        clogParameterCfg.Value = cASTCfg.fdAngle3.ToString
                        clogParameterCfg.DataType = "NUMERIC"
                        lListlogParameter.Add(clogParameterCfg)
                        'RUN_TIME
                        clogParameterCfg = New clslogParameterCfg
                        clogParameterCfg.Identifier = cMachineManager.ActionParameterManager.GetActionParameterParameterValue("AutoStationScrew", cLanguageManager.GetUserTextLine("AutoStationScrew", enumMESParameter.RUN_TIME.ToString), 2)
                    ...
                    Case 23
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationScrew", "44", GetMessage(cSubStepCfg), strResult), enumMainTipsManagerType.Confirm))
                        i.StepInputNumber = i.StepOutputNumber + 1
                    ...
                    Case 24
                        ...
                        If cMainTipsManager.GetMainTipsConfirmTypeFromKey(cRunnerCfg.StationName) = enumMainTipsConfirmType.Abort Then
                            cActionResultCfg.Abort = True
                            cActionResultCfg.Result = False
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationScrew", "44", GetMessage(cSubStepCfg), strResult)
                            cActionResultCfg.ErrorType = enumScrewErrorType.UnKnownError.ToString
                            cActionResultCfg.MESPosition = lListParameter(8).ToString
                            cActionResultCfg.MainErrorType = enumMainScrewErrorType.ScrewError.ToString
                            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("AutoStationScrew", cActionResultCfg.ErrorType, 0)
                    ...
                    Case 101
                        i.StepInputNumber = i.StepInputNumber + 1
                    Case 102
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationScrew", "35", GetMessage(cSubStepCfg))))
                        Return True
                    ...
                    Case 202
                        ...
                        If cASTCfg.fdStatus = 2 Or cASTCfg.fdStatus = 3 Then
                            ...
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationScrew", "38", GetMessage(cSubStepCfg), cASTCfg.fdStep.ToString, cLanguageManager.GetUserTextLine("AutoStationScrew", strErrorType), cASTCfg.fdAngleNOk, cASTCfg.fdAngleLowNOk, cASTCfg.fdAngleUpNOk)
                        ...
                        ElseIf cASTCfg.fdStatus = 4 Or cASTCfg.fdStatus = 5 Then
                            ...
                            cActionResultCfg.Location = cSubStepCfg.SubStepParameter(HMISubStepKeys.ID)
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationScrew", "38", GetMessage(cSubStepCfg), cASTCfg.fdStep.ToString, cLanguageManager.GetUserTextLine("AutoStationScrew", strErrorType), cASTCfg.fdTorqueNOk, cASTCfg.fdTorqueLowNOk, cASTCfg.fdTorqueUpNOk)
                        Else
                            cActionResultCfg.Location = cSubStepCfg.SubStepParameter(HMISubStepKeys.ID)
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationScrew", "39", GetMessage(cSubStepCfg), cASTCfg.fdStep.ToString, cLanguageManager.GetUserTextLine("AutoStationScrew", strErrorType))
                        End If
                        cActionResultCfg.MESPosition = lListParameter(8).ToString
                        cActionResultCfg.ErrorType = strErrorType
                        cActionResultCfg.MainErrorType = enumMainScrewErrorType.ScrewError.ToString
                        cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("AutoStationScrew", strErrorType, 0)
                        cActionResultCfg.Result = False
                        cActionShowManager.UpdateLastActionStepValue(cActionResultCfg.ErrorMessage)
                        Return False
                End Select
