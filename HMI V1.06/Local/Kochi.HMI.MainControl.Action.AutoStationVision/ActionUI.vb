...
Public Class ActionUI
    ...
    Public Function CheckParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.CheckParameter
        ...
        If lListParameter.Count < 1 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("AutoStationInSpection", "2"), enumExceptionType.Alarm)
        End If
        ...
        If IsNothing(cDeviceCfg) Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("AutoStationInSpection", "8", cMachineStationCfg.ID, CInt(lListParameter(0))), enumExceptionType.Alarm)
        End If

        Dim bInitParameter As List(Of String) = clsParameter.ToList(cDeviceCfg.InitParameter)
        If lListParameter.Count < 2 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("AutoStationInSpection", "3"), enumExceptionType.Alarm)
        End If
        ...
        If lListParameter.Count < 3 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("AutoStationInSpection", "9"), enumExceptionType.Alarm)
        End If
        If lListParameter(2) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("AutoStationInSpection", "9"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 4 And bInitParameter(7).ToUpper = "TRUE" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("AutoStationInSpection", "4"), enumExceptionType.Alarm)
        End If
    ...
    Public Function InitControlText() As Boolean
        HmiLabel_InSpection.Label.Text = cLanguageManager.GetUserTextLine("AutoStationInSpection", "HmiLabel_InSpection")
        HmiLabel_InSpection.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiLabel_Program.Label.Text = cLanguageManager.GetUserTextLine("AutoStationInSpection", "HmiLabel_Program")
