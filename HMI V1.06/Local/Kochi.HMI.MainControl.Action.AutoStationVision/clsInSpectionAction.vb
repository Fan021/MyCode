...
<clsHMIActionName("AutoStationInSpection", enumHMIActionType.Auto, enumHMISubActionType.SubAction)>
Public Class clsInSpectionAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
        ...
        cActionResultCfg.CancelAutoContinue = True
        ...
        Try
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    ...
                    Case 100
                        cInSpection.DeletePicture()
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationInSpection", "6", GetMessage(cSubStepCfg))))
                        Return True

                    Case 200
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("AutoStationInSpection", "10", GetMessage(cSubStepCfg))))
                    ...
                    Case 203
                        ...
                        cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationInSpection", "7", GetMessage(cSubStepCfg))
                        ...
                        Else
                            ...
                            cActionResultCfg.MainErrorType = enumInSpectionErrorType.UnKnownError.ToString
                        End If
                        Dim strErrorPosition As String = String.Empty
                        For j = 1 To 19
                            If cPLCAction.ListParmeter(j - 1) = "1" Then
                                If strErrorPosition = "" Then
                                    strErrorPosition = j.ToString
                                Else
                                    strErrorPosition = strErrorPosition + "," + j.ToString
                                End If
                            End If
                        Next
                        If strErrorPosition <> "" Then
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationInSpection", "14", GetMessage(cSubStepCfg), strErrorPosition)
                        Else
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("AutoStationInSpection", "7", GetMessage(cSubStepCfg))
                        End If


                        cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("AutoStationInSpection", cActionResultCfg.ErrorType, 0)
