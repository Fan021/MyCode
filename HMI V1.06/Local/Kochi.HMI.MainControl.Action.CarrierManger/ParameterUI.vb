...
Public Class ParameterUI
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("GlobalStationCarrierManger", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("GlobalStationCarrierManger", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("GlobalStationCarrierManger", "ErrorCode")
        PostTest_ErrorCode.Name = "PostTest_ErrorCode"
        MachineListView_ErrorCode_Value.Columns.Add(PostTest_ErrorCode)

        TabPage1.Text = cLanguageManager.GetUserTextLine("GlobalStationCarrierManger", "TabPage1")

        For Each eType As enumCarrierMangerErrorType In [Enum].GetValues(GetType(enumCarrierMangerErrorType))
