...
Public Class ActionUI
    ...
    Public Function SetParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.SetParameter
        ...
        cLanguageManager = CType(cSystemElement(clsLanguageManager.Name), clsLanguageManager)
        HmiComboBox_CellControl.ComboBox.SelectedIndex = -1
        ...
        lListDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationID(cMachineStationCfg.ID, GetType(Kochi.HMI.MainControl.Device.CellControl.clsCellControl))
        HmiComboBox_CellControl.ComboBox.Items.Clear()
        If Not IsNothing(lListDeviceCfg) Then
            For Each element As clsDeviceCfg In lListDeviceCfg
                HmiComboBox_CellControl.ComboBox.Items.Add(element.Name.ToString)
            Next
        End If
        ...
        If lListParameter.Count >= 1 Then
            For iCnt = 1 To HmiComboBox_CellControl.ComboBox.Items.Count
                If iCnt.ToString = lListParameter(0) Then
                    HmiComboBox_CellControl.ComboBox.SelectedIndex = iCnt - 1
                End If
            Next
        End If
    ...
    Public Function CheckParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.CheckParameter
        ...
        cLanguageManager = CType(cSystemElement(clsLanguageManager.Name), clsLanguageManager)
        If lListParameter.Count < 2 Then
            ' Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationCellControl", "1"), enumExceptionType.Alarm)
        End If

        If lListParameter.Count < 1 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationCellControl", "2"), enumExceptionType.Alarm)
        End If
        ...
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, CInt(lListParameter(0)), GetType(Kochi.HMI.MainControl.Device.CellControl.clsCellControl))
        If IsNothing(cDeviceCfg) Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationCellControl", "4", cMachineStationCfg.ID, CInt(lListParameter(0))), enumExceptionType.Alarm)
        End If

        If lListParameter.Count < 2 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationCellControl", "3"), enumExceptionType.Alarm)
        End If
    ...
    Public Function InitControlText() As Boolean
        HmiLabel_CellControl.Label.Text = cLanguageManager.GetUserTextLine("GlobalStationCellControl", "HmiLabel_CellControl")
        HmiLabel_CellControl.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiLabel_Method.Label.Text = cLanguageManager.GetUserTextLine("GlobalStationCellControl", "HmiLabel_Method")
        HmiLabel_Method.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiComboBox_CellControl.ComboBox.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiComboBox_Method.ComboBox.Font = New System.Drawing.Font("Calibri", 10.0!)
        AddHandler HmiComboBox_CellControl.ComboBox.SelectedIndexChanged, AddressOf ComboBox_SelectedIndexChanged
    ...
    Private Sub TextBoxValue_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        For Each element As RowStyle In TableLayoutPanel_Body.RowStyles
            ...
            element.Height = HmiComboBox_CellControl.ComboBox.Height + 6 + 6
        Next
    End Sub
    ...
    Private Sub GetParamater()
        ...
        If HmiComboBox_CellControl.ComboBox.SelectedIndex >= 0 Then
            lListInitParameter.Add(HmiComboBox_CellControl.ComboBox.SelectedIndex + 1)
        Else
    ...
    Public Function ChangeIniToParameter(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String), ByRef lTargetListParameter As System.Collections.Generic.List(Of String)) As Boolean Implements IActionUI.ChangeIniToParameter
        ...
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, lTargetListParameter(0), GetType(Kochi.HMI.MainControl.Device.CellControl.clsCellControl))
    ...
    Public Function ChangeParameterToIni(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String), ByRef lTargetListParameter As System.Collections.Generic.List(Of String)) As Boolean Implements IActionUI.ChangeParameterToIni
        ...
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, CInt(lTargetListParameter(0)), GetType(Kochi.HMI.MainControl.Device.CellControl.clsCellControl))
