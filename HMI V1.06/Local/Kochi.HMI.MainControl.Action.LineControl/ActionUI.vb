...
Public Class ActionUI
    ...
    Public Function SetParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.SetParameter
        ...
        HmiComboBox_LineControl.ComboBox.SelectedIndex = -1
        ...
        lListDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationID(cMachineStationCfg.ID, GetType(clsHMILineControl))
        HmiComboBox_LineControl.ComboBox.Items.Clear()
        If Not IsNothing(lListDeviceCfg) Then
            For Each element As clsDeviceCfg In lListDeviceCfg
                HmiComboBox_LineControl.ComboBox.Items.Add(element.Name)
            Next
        End If

        HmiComboBox_Method.ComboBox.Items.Clear()
        For Each eType As enumLineControlMethod In [Enum].GetValues(GetType(enumLineControlMethod))
            HmiComboBox_Method.ComboBox.Items.Add(eType.ToString)
        Next

        Dim iCnt As Integer = 0
        If lListParameter.Count >= 1 Then
            For iCnt = 1 To HmiComboBox_LineControl.ComboBox.Items.Count
                If iCnt.ToString = lListParameter(0) Then
                    HmiComboBox_LineControl.ComboBox.SelectedIndex = iCnt - 1
                End If
            Next
        End If
    ...
    Public Function CheckParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.CheckParameter
        ...
        If lListParameter.Count < 2 Then
            ' Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationLineControl", "1"), enumExceptionType.Alarm)
        End If

        If lListParameter.Count < 1 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationLineControl", "2"), enumExceptionType.Alarm)
        End If
        If lListParameter(0) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationLineControl", "2"), enumExceptionType.Alarm)
        End If
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, CInt(lListParameter(0)), GetType(clsHMILineControl))
        If IsNothing(cDeviceCfg) Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationLineControl", "6", cMachineStationCfg.ID, CInt(lListParameter(0))), enumExceptionType.Alarm)
        End If

        If lListParameter.Count < 2 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("GlobalStationLineControl", "3"), enumExceptionType.Alarm)
        End If
    ...
    Public Function InitControlText() As Boolean
        HmiLabel_LineControl.Label.Text = cLanguageManager.GetUserTextLine("GlobalStationLineControl", "HmiLabel_LineControl")
        HmiLabel_LineControl.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiLabel_Method.Label.Text = cLanguageManager.GetUserTextLine("GlobalStationLineControl", "HmiLabel_Method")
        HmiLabel_Method.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiComboBox_LineControl.ComboBox.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiComboBox_Method.ComboBox.Font = New System.Drawing.Font("Calibri", 10.0!)
        AddHandler HmiComboBox_LineControl.ComboBox.SelectedIndexChanged, AddressOf ComboBox_SelectedIndexChanged
    ...
    Private Sub TextBoxValue_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        For Each element As RowStyle In TableLayoutPanel_Body.RowStyles
            ...
            element.Height = HmiComboBox_LineControl.ComboBox.Height + 6 + 6
        Next
    End Sub
    ...
    Private Sub GetParamater()
        ...
        If HmiComboBox_LineControl.ComboBox.SelectedIndex >= 0 Then
            lListInitParameter.Add(HmiComboBox_LineControl.ComboBox.SelectedIndex + 1)
        Else
    ...
    Public Function ChangeIniToParameter(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String), ByRef lTargetListParameter As System.Collections.Generic.List(Of String)) As Boolean Implements IActionUI.ChangeIniToParameter
        ...
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, lTargetListParameter(0), GetType(clsHMILineControl))
    ...
    Public Function ChangeParameterToIni(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String), ByRef lTargetListParameter As System.Collections.Generic.List(Of String)) As Boolean Implements IActionUI.ChangeParameterToIni
        ...
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, CInt(lTargetListParameter(0)), GetType(clsHMILineControl))
        lTargetListParameter(0) = cDeviceCfg.StationIndex
        Return True
    End Function
End Class

Public Enum enumLineControlMethod
    Start = 1
    Complete
    StartWithConfirm
End Enum