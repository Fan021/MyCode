...
<clsHMIActionName("ManualStationChangePage", enumHMIActionType.Manual, enumHMISubActionType.All)>
Public Class clsChangePageAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
        ...
        Try
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    ...
                    Case 1
                        cMachineStatusManager.AddDisablePage(cRunnerCfg.StationName, True)
                        cMachineStatusManager.AddPage(cRunnerCfg.StationName)
                        i.StepInputNumber = 100

                    Case 100
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationChangePage", "1", GetMessage(cSubStepCfg))))
                        Return True

                    Case 200
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationChangePage", "2", GetMessage(cSubStepCfg))))
                        i.StepInputNumber = i.StepInputNumber + 1

                    Case 201
                        cActionResultCfg.Result = False
                        cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationChangePage", "2", GetMessage(cSubStepCfg))
                        cActionResultCfg.ErrorType = enumChangePageErrorType.ChangePageError.ToString
                        cActionResultCfg.MainErrorType = enumMainChangePageErrorType.ChangePageError.ToString
                        cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationChangePage", cActionResultCfg.ErrorType, 0)
                        Return False
                End Select
            Loop
            Return True
        Catch ex As Exception
            ...
            cActionResultCfg.ErrorType = enumChangePageErrorType.UnKnownError.ToString
            cActionResultCfg.MainErrorType = enumMainChangePageErrorType.ChangePageError.ToString
            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationChangePage", cActionResultCfg.ErrorType, 0)
            Return False
...
Public Enum enumMainChangePageErrorType
    ChangePageError = 1
End Enum

Public Enum enumChangePageErrorType
    ChangePageError = 1
    UnKnownError = 2
End Enum
