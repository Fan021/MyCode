...
Public Class ParameterUI
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("ManualStationConnect", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("ManualStationConnect", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("ManualStationConnect", "ErrorCode")
        PostTest_ErrorCode.Name = "PostTest_ErrorCode"
        MachineListView_ErrorCode_Value.Columns.Add(PostTest_ErrorCode)

        TabPage1.Text = cLanguageManager.GetUserTextLine("ManualStationConnect", "TabPage1")

        For Each eType As enumConnectErrorType In [Enum].GetValues(GetType(enumConnectErrorType))
