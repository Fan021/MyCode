...
Public Class PicturePosition
    ...
    Public Function Init(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object)) As Boolean
        ...
        Label_Radius.Text = cLanguageManager.GetUserTextLine("ManualStationConnect", "Label_Radius")
        Label_X.Font = New System.Drawing.Font("Calibri", 12.0!)
        Label_X.Text = cLanguageManager.GetUserTextLine("ManualStationConnect", "Label_X")
        Label_Y.Font = New System.Drawing.Font("Calibri", 12.0!)
        Label_Y.Text = cLanguageManager.GetUserTextLine("ManualStationConnect", "Label_Y")
        HmiButton_Confirm.Button.Text = cLanguageManager.GetUserTextLine("ManualStationConnect", "HmiButton_Confirm")
        HmiButton_Cancel.Button.Text = cLanguageManager.GetUserTextLine("ManualStationConnect", "HmiButton_Cancel")
