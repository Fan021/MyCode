...
Public Class ParameterUI
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("ManualStationDoAction", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("ManualStationDoAction", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("ManualStationDoAction", "ErrorCode")
        PostTest_ErrorCode.Name = "PostTest_ErrorCode"
        MachineListView_ErrorCode_Value.Columns.Add(PostTest_ErrorCode)

        TabPage1.Text = cLanguageManager.GetUserTextLine("ManualStationDoAction", "TabPage1")

        For Each eType As enumDoActionErrorType In [Enum].GetValues(GetType(enumDoActionErrorType))
