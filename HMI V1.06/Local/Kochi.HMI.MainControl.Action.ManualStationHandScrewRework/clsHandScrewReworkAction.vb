...
<clsHMIActionName("ManualStationHandScrewRework", enumHMIActionType.Manual, enumHMISubActionType.SubSubAction)>
Public Class clsHandScrewReworkAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
        ...
        bExit = False
        Dim cPKP As clsHMIPKP = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, lListParameter(0), GetType(clsHMIPKP)).Source
        ...
        Try
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    ...
                    Case 100
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationHandScrewRework", "4", GetMessage(cSubStepCfg))))
                        Return True

                    Case 200
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationHandScrewRework", "5", GetMessage(cSubStepCfg))))
                        i.StepInputNumber = i.StepInputNumber + 1

                    Case 201
                        cActionResultCfg.Result = False
                        cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationHandScrewRework", "5", GetMessage(cSubStepCfg))
                        cActionResultCfg.ErrorType = enumHandScrewReworkErrorType.HandScrewReworkError.ToString
                        cActionResultCfg.MainErrorType = enumMainHandScrewReworkErrorType.HandScrewReworkError.ToString
                        cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationHandScrewRework", cActionResultCfg.ErrorType, 0)
                        Return False
                End Select
            Loop
            Return True
        Catch ex As Exception
            ...
            cActionResultCfg.ErrorType = enumHandScrewReworkErrorType.UnKnownError.ToString
            cActionResultCfg.MainErrorType = enumMainHandScrewReworkErrorType.HandScrewReworkError.ToString
            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationHandScrewRework", cActionResultCfg.ErrorType, 0)
            Return False
...
Public Enum enumMainHandScrewReworkErrorType
    HandScrewReworkError = 1
End Enum

Public Enum enumHandScrewReworkErrorType
    HandScrewReworkError = 1
    UnKnownError = 2
End Enum
