...
Public Class ActionUI
    ...
    Public Function SetParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.SetParameter
        ...
        If lListParameter.Count > 2 Then
            ...
            If lListParameter.Count Mod 2 = 1 Then
                iMaxCount = lListParameter.Count
            Else
                iMaxCount = lListParameter.Count - 1
            End If
            Dim strValue As String = cMachineManager.ActionParameterManager.ListElement("ManualStationPlcDoAction")
        ...
        End If
        If lListParameter.Count = 2 Then
            RadioButton_Y.Checked = IIf(lListParameter(1).ToUpper = "TRUE", True, False)
            RadioButton_N.Checked = Not RadioButton_Y.Checked
        End If
        If lListParameter.Count > 2 And lListParameter.Count Mod 2 = 0 Then
            RadioButton_Y.Checked = IIf(lListParameter(lListParameter.Count - 1).ToUpper = "TRUE", True, False)
            RadioButton_N.Checked = Not RadioButton_Y.Checked
        End If
        GetParamater()
    ...
    Public Function CheckParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.CheckParameter
        ...
        cLanguageManager = CType(cSystemElement(clsLanguageManager.Name), clsLanguageManager)
        If lListParameter.Count < 1 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "2"), enumExceptionType.Alarm)
        End If
        ...
        For i = 0 To MachineListView_Parameter.Rows.Count - 1
            If MachineListView_Parameter.Rows(i).Cells(2).Value = "" Then
                Throw New clsHMIException(cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "6", MachineListView_Parameter.Rows(i).Cells(1).Value), enumExceptionType.Alarm)
            End If
        Next
    ...
    Public Function InitControlText() As Boolean
        HmiLabel_Name.Label.Text = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "HmiLabel_Name")
        HmiLabel_Name.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        '  HmiLabel_Parameter.Label.Text = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "HmiLabel_Parameter")
        HmiLabel_Name.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        ...
        HmiLabel_OneTime.Label.Text = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "HmiLabel_OneTime")
        HmiLabel_OneTime.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        RadioButton_Y.Text = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "RadioButton_Y")
        RadioButton_Y.Font = New System.Drawing.Font("Calibri", 10.0!)
        RadioButton_N.Text = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "RadioButton_N")
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "PostTest_id")
        ...
        PostTest_Name.HeaderText = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "PostTest_Name")
        ...
        PostTest_Value.HeaderText = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "PostTest_Value")
        PostTest_Value.Name = "PostTest_Value"
        PostTest_Value.ReadOnly = False
        MachineListView_Parameter.Columns.Add(PostTest_Value)

        If cMachineManager.ActionParameterManager.ListElement.ContainsKey("ManualStationPlcDoAction") Then
            Dim strValue As String = cMachineManager.ActionParameterManager.ListElement("ManualStationPlcDoAction")
            Dim cValue() As String = strValue.Split("|")
    ...
    Private Sub TextBoxValue_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If cMachineManager.MachineGlobalParameter.GetGlobalParameter(clsHMIGlobalParameter.Company) = "KOI" Then
            TableLayoutPanel_Body.RowStyles(1).Height = 0
        End If
    End Sub
    ...
    Private Sub GetParamater()
        ...
        Next
        lListInitParameter.Add(RadioButton_Y.Checked.ToString.ToUpper)
    ...
    Public Function ChangeIniToParameter(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String), ByRef lTargetListParameter As System.Collections.Generic.List(Of String)) As Boolean Implements IActionUI.ChangeIniToParameter
        ...
        If lTargetListParameter.Count = 1 Then
            lTargetListParameter.Add("False")
        End If

        If lTargetListParameter.Count > 2 And lTargetListParameter.Count Mod 2 = 1 Then
            lTargetListParameter.Add("False")
        End If
