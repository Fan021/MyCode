...
Public Class AddForm
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_Name.HeaderText = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "Parameter")
        ...
        PostTest_Value.HeaderText = cLanguageManager.GetUserTextLine("ManualStationPlcDoAction", "Value")
