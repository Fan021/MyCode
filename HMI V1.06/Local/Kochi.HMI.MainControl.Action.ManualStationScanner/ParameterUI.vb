...
Public Class ParameterUI
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("ManualStationScan", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("ManualStationScan", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("ManualStationScan", "ErrorCode")
        PostTest_ErrorCode.Name = "PostTest_ErrorCode"
        MachineListView_ErrorCode_Value.Columns.Add(PostTest_ErrorCode)

        For Each eType As enumScannerErrorType In [Enum].GetValues(GetType(enumScannerErrorType))
        ...
        PostTest_name.HeaderText = cLanguageManager.GetUserTextLine("ManualStationScan", "Name")
        ...
        PostTest_value.HeaderText = cLanguageManager.GetUserTextLine("ManualStationScan", "Device")
        PostTest_value.Name = "PostTest_value"
        MachineListView_Device_Value.Columns.Add(PostTest_value)

        TabPage1.Text = cLanguageManager.GetUserTextLine("ManualStationScan", "TabPage1")
        TabPage2.Text = cLanguageManager.GetUserTextLine("ManualStationScan", "TabPage2")
