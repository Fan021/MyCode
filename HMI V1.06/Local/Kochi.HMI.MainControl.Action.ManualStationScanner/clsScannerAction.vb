...
<clsHMIActionName("ManualStationScan", enumHMIActionType.Manual, enumHMISubActionType.All)>
Public Class clsScannerAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
        ...
        Dim strDevice As String = cMachineManager.ActionParameterManager.GetActionParameterDevice("ManualStationScan", cMachineStationCfg.ID, 1)
            ...
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    ...
                    Case 0
                        ...
                        If TypeOf cHMIScanner Is clsHMIManualScanner Then
                    ...
                    Case 110
                        CType(cHMIScanner, clsHMIManualScanner).isActive = False
                        i.StepInputNumber = i.StepInputNumber + 1

                    Case 111
                        If CType(cHMIScanner, clsHMIManualScanner).isActive Then
                            cActionShowManager.UpdateLastActionStepValue(CType(cHMIScanner, clsHMIManualScanner).ScanResult)
                            i.StepInputNumber = i.StepInputNumber + 1
                        End If
                    ...
                    Case 112
                        ...
                        If Not cScanResult.Scanner(lListParameter(0), cSubStepCfg.SubStepParameter(HMISubStepKeys.Name), lListParameter(1), cLocalElement, cSystemElement, CType(cHMIScanner, clsHMIManualScanner).ScanResult, strErrorMsg) Then
                            cActionResultCfg.Result = False
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationScan", "6", GetMessage(cSubStepCfg), strErrorMsg)
                            ...
                            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScan", cActionResultCfg.ErrorType, 0)
                            Return False
                        Else
                    ...
                    Case 321
                        ...
                        If IsNothing(cDeviceCfg) Then
                            cActionResultCfg.Result = False
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationScan", "7", GetMessage(cSubStepCfg), strDeviceIndex)
                    ...
                    Case 322
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScan", "8", GetMessage(cSubStepCfg))))
                        If Not CType(cHMIDeviceBase, clsHMIMES).validateSfc(cLocalVariantManager.CurrentVariantCfg.SFC, cBarcodeManager.SFC, strResult) Then
                            cActionResultCfg.Result = False
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationScan", "6", GetMessage(cSubStepCfg), strResult)
                            cActionResultCfg.ErrorType = enumScannerErrorType.UnKnownError.ToString
                            cActionResultCfg.MainErrorType = enumMainScannerErrorType.ScannerError.ToString
                            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScan", cActionResultCfg.ErrorType, 0)
                            Return False
                    ...
                    Case 323
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScan", "10", GetMessage(cSubStepCfg))))
                    ...
                    Case 333
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScan", "9", GetMessage(cSubStepCfg))))
                    ...
                    Case 342
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScan", "11", GetMessage(cSubStepCfg))))
                        If Not CType(cHMIDeviceBase, clsHMIMES).Start(cBarcodeManager.SFC, strResult) Then
                            cActionResultCfg.Result = False
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationScan", "6", GetMessage(cSubStepCfg), "Start:" + strResult)
                            cActionResultCfg.ErrorType = enumScannerErrorType.UnKnownError.ToString
                            cActionResultCfg.MainErrorType = enumMainScannerErrorType.ScannerError.ToString
                            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScan", cActionResultCfg.ErrorType, 0)
                            Return False
                    ...
                    Case 343
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScan", "12", GetMessage(cSubStepCfg))))
                        If Not CType(cHMIDeviceBase, clsHMIMES).Complete(cBarcodeManager.SFC, strResult) Then
                            cActionResultCfg.Result = False
                            cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationScan", "6", GetMessage(cSubStepCfg), "Complete:" + strResult)
                            cActionResultCfg.ErrorType = enumScannerErrorType.UnKnownError.ToString
                            cActionResultCfg.MainErrorType = enumMainScannerErrorType.ScannerError.ToString
                            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScan", cActionResultCfg.ErrorType, 0)
                            Return False
                    ...
                    Case 400
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScan", "5", GetMessage(cSubStepCfg))))
                        Return True
