...
<clsHMIActionName("ManualStationScrewBit", enumHMIActionType.Manual, enumHMISubActionType.SubAction)>
Public Class clsInScrewBitAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
            ...
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    Case 0
                        ...
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScrewBit", "4", GetMessage(cSubStepCfg), lListParameter(1))))
                    ...
                    Case 100
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScrewBit", "5", GetMessage(cSubStepCfg), lListParameter(1))))
                        Return True

                    Case 200
                        cActionResultCfg.Result = False
                        cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationScrewBit", "6", GetMessage(cSubStepCfg), lListParameter(1))
                        cActionResultCfg.ErrorType = enumScrewBitErrorType.ScrewBitError.ToString
                        cActionResultCfg.MainErrorType = enumMainScrewBitErrorType.ScrewBitError.ToString
                        cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScrewBit", cActionResultCfg.ErrorType, 0)
                        Return False
                End Select
            Loop
            Return True
        Catch ex As Exception
            ...
            cActionResultCfg.ErrorType = enumScrewBitErrorType.UnKnownError.ToString
            cActionResultCfg.MainErrorType = enumMainScrewBitErrorType.ScrewBitError.ToString
            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScrewBit", cActionResultCfg.ErrorType, 0)
...
Public Enum enumMainScrewBitErrorType
    ScrewBitError = 1
End Enum

Public Enum enumScrewBitErrorType
    ScrewBitError = 1
    UnKnownError = 2
End Enum
