...
<clsHMIActionName("ManualStationScrewDiscard", enumHMIActionType.Manual, enumHMISubActionType.SubSubAction)>
Public Class clsScrewDiscardAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
            ...
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    Case 0
                        ...
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScrewDiscard", "3", GetMessage(cSubStepCfg))))
                        i.StepInputNumber = i.StepInputNumber + 1

                    Case 1
                        If cPLCAction.HmiAction.bulPLCDoAction Then
                            cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScrewDiscard", "4", GetMessage(cSubStepCfg))))
                    ...
                    Case 100
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScrewDiscard", "1", GetMessage(cSubStepCfg))))
                        Return True

                    Case 200
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScrewDiscard", "2", GetMessage(cSubStepCfg))))
                        i.StepInputNumber = i.StepInputNumber + 1

                    Case 201
                        cActionResultCfg.Result = False
                        cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationScrewDiscard", "2", GetMessage(cSubStepCfg))
                        cActionResultCfg.ErrorType = enumScrewDiscardErrorType.ScrewDiscardError.ToString
                        cActionResultCfg.MainErrorType = enumMainScrewDiscardErrorType.ScrewDiscardError.ToString
                        cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScrewDiscard", cActionResultCfg.ErrorType, 0)
                        Return False
                End Select
            Loop
            Return True
        Catch ex As Exception
            ...
            cActionResultCfg.ErrorType = enumScrewDiscardErrorType.UnKnownError.ToString
            cActionResultCfg.MainErrorType = enumMainScrewDiscardErrorType.ScrewDiscardError.ToString
            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScrewDiscard", cActionResultCfg.ErrorType, 0)
            Return False
...
Public Enum enumMainScrewDiscardErrorType
    ScrewDiscardError = 1
End Enum

Public Enum enumScrewDiscardErrorType
    ScrewDiscardError = 1
    UnKnownError = 2
End Enum
