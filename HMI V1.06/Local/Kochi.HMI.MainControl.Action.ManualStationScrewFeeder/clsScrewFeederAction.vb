...
<clsHMIActionName("ManualStationScrewFeeder", enumHMIActionType.Manual, enumHMISubActionType.SubSubAction)>
Public Class clsScrewFeederAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
        ...
        Try
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    ...
                    Case 100
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScrewFeeder", "3", GetMessage(cSubStepCfg))))
                        Return True

                    Case 200
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationScrewFeeder", "4", GetMessage(cSubStepCfg))))
                        i.StepInputNumber = i.StepInputNumber + 1

                    Case 201
                        cActionResultCfg.Result = False
                        cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationScrewFeeder", "4", GetMessage(cSubStepCfg))
                        cActionResultCfg.ErrorType = enumScrewFeederErrorType.ScrewFeederError.ToString
                        cActionResultCfg.MainErrorType = enumMainScrewFeederErrorType.ScrewFeederError.ToString
                        cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScrewFeeder", cActionResultCfg.ErrorType, 0)
                        Return False
                End Select
            Loop
            Return True
        Catch ex As Exception
            ...
            cActionResultCfg.ErrorType = enumScrewFeederErrorType.UnKnownError.ToString
            cActionResultCfg.MainErrorType = enumMainScrewFeederErrorType.ScrewFeederError.ToString
            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationScrewFeeder", cActionResultCfg.ErrorType, 0)
            Return False
...
Public Enum enumMainScrewFeederErrorType
    ScrewFeederError = 1
End Enum

Public Enum enumScrewFeederErrorType
    ScrewFeederError = 1
    UnKnownError = 2
End Enum
