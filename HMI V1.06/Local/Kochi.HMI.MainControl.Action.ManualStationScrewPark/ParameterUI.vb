...
Public Class ParameterUI
    ...
    Private cHMIPKP As Kochi.HMI.MainControl.Device.ScrewPark.clsScrewPark
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("ManualStationScrewPark", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("ManualStationScrewPark", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("ManualStationScrewPark", "ErrorCode")
        PostTest_ErrorCode.Name = "PostTest_ErrorCode"
        MachineListView_ErrorCode_Value.Columns.Add(PostTest_ErrorCode)

        TabPage1.Text = cLanguageManager.GetUserTextLine("ManualStationScrewPark", "TabPage1")

        For Each eType As enumScrewParkErrorType In [Enum].GetValues(GetType(enumScrewParkErrorType))
