...
Public Class ActionUI
    ...
    Public Function SetParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.SetParameter
        ...
        cLanguageManager = CType(cSystemElement(clsLanguageManager.Name), clsLanguageManager)
        HmiComboBox_TapeFeeder.ComboBox.SelectedIndex = -1
        iParentProgramUI.SetRepeat(enumProgramCounType.Manual_Continue)

        Dim lListDeviceCfg As List(Of clsDeviceCfg)
        lListDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationID(cMachineStationCfg.ID, GetType(Kochi.HMI.MainControl.Device.TapeFeeder.clsTapeFeeder))
        HmiComboBox_TapeFeeder.ComboBox.Items.Clear()
        If Not IsNothing(lListDeviceCfg) Then
            For Each element As clsDeviceCfg In lListDeviceCfg
                HmiComboBox_TapeFeeder.ComboBox.Items.Add(element.Name.ToString)
            Next
        End If


        If lListParameter.Count >= 1 Then
            For iCnt = 1 To HmiComboBox_TapeFeeder.ComboBox.Items.Count
                If iCnt.ToString = lListParameter(0) Then
                    HmiComboBox_TapeFeeder.ComboBox.SelectedIndex = iCnt - 1
                End If
            Next
        End If
    ...
    Public Function CheckParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IActionUI.CheckParameter
        ...
        If lListParameter.Count < 2 Then
            ' Throw New clsHMIException(cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "1"), enumExceptionType.Alarm)
        End If

        If lListParameter.Count < 1 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "2"), enumExceptionType.Alarm)
        End If
        ...
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, CInt(lListParameter(0)), GetType(Kochi.HMI.MainControl.Device.TapeFeeder.clsTapeFeeder))
        If IsNothing(cDeviceCfg) Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "3", cMachineStationCfg.ID, CInt(lListParameter(0))), enumExceptionType.Alarm)
        End If
    ...
    Public Function InitControlText() As Boolean
        HmiLabel_PKP.Label.Text = cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "HmiLabel_PKP")
        HmiLabel_PKP.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiComboBox_TapeFeeder.ComboBox.Font = New System.Drawing.Font("Calibri", 10.0!)
        AddHandler HmiComboBox_TapeFeeder.ComboBox.SelectedIndexChanged, AddressOf ComboBox_SelectedIndexChanged
        AddHandler HmiComboBox_TapeFeeder.ComboBox.SizeChanged, AddressOf TextBoxValue_SizeChanged
    ...
    Private Sub TextBoxValue_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        For Each element As RowStyle In TableLayoutPanel_Body.RowStyles
            ...
            element.Height = HmiComboBox_TapeFeeder.ComboBox.Height + 6 + 6
        Next
    End Sub
    ...
    Private Sub GetParamater()
        ...
        If HmiComboBox_TapeFeeder.ComboBox.SelectedIndex >= 0 Then
            lListInitParameter.Add(HmiComboBox_TapeFeeder.ComboBox.SelectedIndex + 1)
        Else
    ...
    Public Function ChangeIniToParameter(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String), ByRef lTargetListParameter As System.Collections.Generic.List(Of String)) As Boolean Implements IActionUI.ChangeIniToParameter
        ...
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, lTargetListParameter(0), GetType(Kochi.HMI.MainControl.Device.TapeFeeder.clsTapeFeeder))
    ...
    Public Function ChangeParameterToIni(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String), ByRef lTargetListParameter As System.Collections.Generic.List(Of String)) As Boolean Implements IActionUI.ChangeParameterToIni
        ...
        Dim cDeviceCfg As clsDeviceCfg = cDeviceManager.GetDeviceFromTypeAndStationIndex(cMachineStationCfg.ID, CInt(lTargetListParameter(0)), GetType(Kochi.HMI.MainControl.Device.TapeFeeder.clsTapeFeeder))
