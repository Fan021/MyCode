...
Public Class ParameterUI
    ...
    Private cHMIPKP As Kochi.HMI.MainControl.Device.TapeFeeder.clsTapeFeeder
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "ErrorCode")
        PostTest_ErrorCode.Name = "PostTest_ErrorCode"
        MachineListView_ErrorCode_Value.Columns.Add(PostTest_ErrorCode)

        TabPage1.Text = cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "TabPage1")

        For Each eType As enumTapeFeederErrorType In [Enum].GetValues(GetType(enumTapeFeederErrorType))
