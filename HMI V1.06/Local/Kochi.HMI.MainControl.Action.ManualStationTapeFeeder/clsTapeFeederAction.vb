...
<clsHMIActionName("ManualStationTapeFeeder", enumHMIActionType.Manual, enumHMISubActionType.All)>
Public Class clsTapeFeederAction
    ...
    Public Overrides Function Run(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As System.Collections.Generic.List(Of String)) As Boolean
        ...
        Try
            Do While Not bExit
                ...
                Select Case i.StepOutputNumber
                    ...
                    Case 100
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "4", GetMessage(cSubStepCfg))))
                        Return True

                    Case 200
                        cMainTipsManager.AddTips(New clsMainTipsManagerCfg(cRunnerCfg.StationName, cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "5", GetMessage(cSubStepCfg))))
                        i.StepInputNumber = i.StepInputNumber + 1

                    Case 201
                        cActionResultCfg.Result = False
                        cActionResultCfg.ErrorMessage = cLanguageManager.GetUserTextLine("ManualStationTapeFeeder", "5", GetMessage(cSubStepCfg))
                        cActionResultCfg.ErrorType = enumTapeFeederErrorType.TapeFeederError.ToString
                        cActionResultCfg.MainErrorType = enumMainTapeFeederErrorType.TapeFeederError.ToString
                        cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationTapeFeeder", cActionResultCfg.ErrorType, 0)
                        Return False
                End Select
            Loop
            Return True
        Catch ex As Exception
            ...
            cActionResultCfg.ErrorType = enumTapeFeederErrorType.UnKnownError.ToString
            cActionResultCfg.MainErrorType = enumMainTapeFeederErrorType.TapeFeederError.ToString
            cActionResultCfg.ErrorCode = cMachineManager.ActionParameterManager.GetActionParameterErrorCode("ManualStationTapeFeeder", cActionResultCfg.ErrorType, 0)
            Return False
...
Public Enum enumMainTapeFeederErrorType
    TapeFeederError = 1
End Enum

Public Enum enumTapeFeederErrorType
    TapeFeederError = 1
    UnKnownError = 2
End Enum
