...
Public Class ParameterUI
    ...
    Public Function InitControlText() As Boolean
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("GlobalStationMES", "ID")
        ...
        PostTest_ErrorType.HeaderText = cLanguageManager.GetUserTextLine("GlobalStationMES", "ErrorType")
        ...
        PostTest_ErrorCode.HeaderText = cLanguageManager.GetUserTextLine("GlobalStationMES", "ErrorCode")
        PostTest_ErrorCode.Name = "PostTest_ErrorCode"
        MachineListView_ErrorCode_Value.Columns.Add(PostTest_ErrorCode)

        TabPage1.Text = cLanguageManager.GetUserTextLine("GlobalStationMES", "TabPage1")

        For Each eType As enumVariantChangeErrorType In [Enum].GetValues(GetType(enumVariantChangeErrorType))
