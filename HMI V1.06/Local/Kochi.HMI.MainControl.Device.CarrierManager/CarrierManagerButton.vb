...
Public Class CarrierManagerButton
    Inherits Button
    ...
    Protected Overrides Sub OnPaint(ByVal pevent As System.Windows.Forms.PaintEventArgs)
        ...
        Select Case eGapFillerButtonValue
            Case enumGapFillerButtonValue.NONE
                ...
                pevent.Graphics.FillRectangle(brush, Me.Width - Single.Parse(Me.Width / 8) - 3, 3, Single.Parse(Me.Width / 8), Single.Parse(Me.Height - 6))
