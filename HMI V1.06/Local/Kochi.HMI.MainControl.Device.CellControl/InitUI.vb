...
Public Class InitUI
    ...
    Public Function CheckParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IInitUI.CheckParameter
        ...
        If lListParameter.Count < 1 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("CellControl", "2"), enumExceptionType.Alarm)
        End If
        If lListParameter(0) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("CellControl", "2"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 2 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("CellControl", "3"), enumExceptionType.Alarm)
        End If
        If lListParameter(1) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("CellControl", "3"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 3 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("CellControl", "4"), enumExceptionType.Alarm)
        End If
        If lListParameter(2) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("CellControl", "4"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 4 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("CellControl", "5"), enumExceptionType.Alarm)
        End If
    ...
    Public Function InitForm() As Boolean
        Me.TopLevel = False
        Me.HmiLabel_Operation.Label.Text = cLanguageManager.GetUserTextLine("CellControl", "HmiLabel_Operation")
        Me.HmiLabel_Address.Label.Text = cLanguageManager.GetUserTextLine("CellControl", "HmiLabel_Address")
        Me.HmiLabel_UserName.Label.Text = cLanguageManager.GetUserTextLine("CellControl", "HmiLabel_UserName")
        Me.HmiLabel_Password.Label.Text = cLanguageManager.GetUserTextLine("CellControl", "HmiLabel_Password")
        Me.HmiLabel_Inqueue.Label.Text = cLanguageManager.GetUserTextLine("CellControl", "HmiLabel_Inqueue")
