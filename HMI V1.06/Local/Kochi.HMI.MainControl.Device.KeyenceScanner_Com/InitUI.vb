...
Public Class InitUI
    ...
    Public Function SetParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListInitParameter As List(Of String)) As Boolean Implements IInitUI.SetParameter
        ...
        If lListInitParameter.Count >= 6 Then
            HmiTextBox_TimeOut.TextBox.Text = lListInitParameter(5)
        End If
    ...
    Public Function CheckParameter(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListParameter As List(Of String)) As Boolean Implements IInitUI.CheckParameter
        ...
        If lListParameter.Count < 1 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "3"), enumExceptionType.Alarm)
        End If
        If lListParameter(0) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "3"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 2 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "4"), enumExceptionType.Alarm)
        End If
        If lListParameter(1) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "4"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 3 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "5"), enumExceptionType.Alarm)
        End If
        If lListParameter(2) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "5"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 4 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "6"), enumExceptionType.Alarm)
        End If
        If lListParameter(3) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "6"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 5 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "7"), enumExceptionType.Alarm)
        End If
        If lListParameter(4) = "" Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "7"), enumExceptionType.Alarm)
        End If
        If lListParameter.Count < 6 Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "11"), enumExceptionType.Alarm)
        End If
    ...
    Public Function InitForm() As Boolean
        Me.TopLevel = False
        Me.HmiLabel_Port.Label.Text = cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "HmiLabel_Port")
        Me.HmiLabel_BaudRate.Label.Text = cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "HmiLabel_BaudRate")
        Me.HmiLabel_Parity.Label.Text = cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "HmiLabel_Parity")
        Me.HmiLabel_DataBits.Label.Text = cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "HmiLabel_DataBits")
        Me.HmiLabel_StopBits.Label.Text = cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "HmiLabel_StopBits")
        Me.HmiLabel_TimeOut.Label.Text = cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "HmiLabel_TimeOut")
