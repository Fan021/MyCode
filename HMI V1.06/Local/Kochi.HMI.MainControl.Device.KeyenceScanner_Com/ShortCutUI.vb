...
Public Class ShortCutUI
    ...
    Public Const FormName As String = "KeyenceScanner_ComShortcutUI"
    ...
    Public Function InitControlText() As Boolean
        HmiButton_On.Text = cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "HmiButton_On")
        HmiButton_Off.Text = cLanguageManager.GetUserTextLine("KeyenceScanner_Com", "HmiButton_Off")
