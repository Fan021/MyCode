...
<clsHMIDeviceNameAttribute("PKP", "PKP")>
Public Class clsPKP
    Inherits clsHMIPKP
    ...
    Public Overrides Function Init(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListInitParameter As List(Of String), ByVal lListControlParameter As List(Of String)) As Boolean
        ...
        If IsNothing(cHMIPLC) Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("PKP", "1"), enumExceptionType.Crash)
            Return False
        End If
    ...
    Public Overrides ReadOnly Property ReWorkEnable As Boolean
        Get
            Return IIf(lListInitParameter(1).ToString.ToUpper = "TRUE", True, False)
        End Get
    End Property
End Class

<StructLayout(LayoutKind.Sequential, Pack:=1)>
Public Class StructPKP
    ...
    <MarshalAs(UnmanagedType.I1, SizeConst:=1)> Public bulHMIXHome As Boolean = False
    <MarshalAs(UnmanagedType.I1, SizeConst:=1)> Public bulHMIYHome As Boolean = False
