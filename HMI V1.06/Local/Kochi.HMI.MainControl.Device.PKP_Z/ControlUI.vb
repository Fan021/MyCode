...
Public Class ControlUI
    ...
    Public Const FormName As String = "PKP_ZControlUI"
    ...
    Public Function InitControlText() As Boolean
        ...
        HmiLabel_Variant.Label.Text = cLanguageManager.GetUserTextLine("PKP_Z", "HmiLabel_Variant")
        ...
        HmiLabel_Function.Label.Text = cLanguageManager.GetUserTextLine("PKP_Z", "HmiLabel_Function")
        HmiLabel_Function.Label.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiButton_Variant.Text = cLanguageManager.GetUserTextLine("PKP_Z", "HmiButton_Variant")
        ...
        '  HmiButton_Modify.Text = cLanguageManager.GetUserTextLine("PKP_Z", "HmiButton_Modify")
        '  HmiButton_Modify.Button.Font = New System.Drawing.Font("Calibri", 10.0!)
        HmiButton_Save.Text = cLanguageManager.GetUserTextLine("PKP_Z", "HmiButton_Save")
        ...
        PostTest_id.HeaderText = cLanguageManager.GetUserTextLine("PKP_Z", "ID")
        ...
        PostTest_Action.HeaderText = cLanguageManager.GetUserTextLine("PKP_Z", "Action")
        ...
        PostTest_TZ.HeaderText = cLanguageManager.GetUserTextLine("PKP_Z", "ToleranceZ")
        PostTest_TZ.Name = "PostTest_TZ"
        HmiDataView_Point.Columns.Add(PostTest_TZ)

        Dim PostTest_AST As New DataGridViewTextBoxColumn
        PostTest_AST.HeaderText = cLanguageManager.GetUserTextLine("PKP_Z", "AST")
        ...
        PostTest_Program.HeaderText = cLanguageManager.GetUserTextLine("PKP_Z", "Program")
                    ...
                    For Each elementMainStepCfg As clsMainStepCfg In lListMainStepCfg
                        ...
                        For Each elementSubKey As String In elementMainStepCfg.GetSubStepListKey
                            ...
                            If elementMainStepCfg.GetSubStepCfgFromKey(elementSubKey).SubStepParameter(HMISubStepKeys.ActionType) <> "ManualStationScrew" Then
                                ...
                                Continue For
                            End If
                            If cDeviceManager.GetDeviceFromName(cPKP_Z.Name).StationIndex.ToString <> lListParameter(4) Then
                                j = j + 1
                                Continue For
                            End If
                            If cDeviceManager.GetDeviceFromName(cPKP_Z.Name).StationID.ToString <> element Then
                                j = j + 1
                                Continue For
                            End If
    ...
    Public Sub Showdefault()
        ...
        If HmiDataView_Point.CurrentRow.Index <= HmiDataView_Point.Rows.Count - 1 Then
            ...
            HmiTextBox_ToleranceY.Text = HmiDataView_Point.Rows(HmiDataView_Point.CurrentRow.Index).Cells(6).Value
            ...
            HmiTextBox_AST.TextBox.Text = HmiDataView_Point.Rows(HmiDataView_Point.CurrentRow.Index).Cells(8).Value
            HmiTextBox_Pro.TextBox.Text = HmiDataView_Point.Rows(HmiDataView_Point.CurrentRow.Index).Cells(9).Value
    ...
    Private Sub Modify()
        ...
        If HmiDataView_Point.CurrentRow.Index <= HmiDataView_Point.Rows.Count - 1 Then
            ...
            lListParameter(9) = HmiTextBox_MoveZ.Text
            lListParameter(10) = HmiTextBox_ToleranceZ.Text
            cActionManager.ChangeCurrentSubParameter(lListActionStep(HmiDataView_Point.Rows(HmiDataView_Point.CurrentRow.Index).Cells(0).Value).Station,
                                                     lListActionStep(HmiDataView_Point.Rows(HmiDataView_Point.CurrentRow.Index).Cells(0).Value).Action,
                                                     lListActionStep(HmiDataView_Point.Rows(HmiDataView_Point.CurrentRow.Index).Cells(0).Value).MainStepIndex,
                                                     lListActionStep(HmiDataView_Point.Rows(HmiDataView_Point.CurrentRow.Index).Cells(0).Value).SubStepIndex,
        ...
        Try
            If cActionManager.CheckCurrentActionCfg() Then
                If cActionManager.SaveCurrentActionCfg(HmiComboBox_Variant.ComboBox.Text) Then
                    cErrorMessageManager.AddHMIException(New clsHMIException(cLanguageManager.GetUserTextLine("PKP_Z", "4"), enumExceptionType.Normal, ControlUI.FormName))
                Else
                    cErrorMessageManager.AddHMIException(New clsHMIException(cLanguageManager.GetUserTextLine("PKP_Z", "5"), enumExceptionType.Normal, ControlUI.FormName))
                End If
                HmiButton_Save.Button.Enabled = cActionManager.IsChanged
            End If
        Catch ex As Exception
