...
<clsHMIDeviceNameAttribute("PKS", "PKS")>
Public Class clsPKS
    Inherits clsHMIPKS
    ...
    Public Overrides Function Init(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListInitParameter As List(Of String), ByVal lListControlParameter As List(Of String)) As Boolean
        ...
        If IsNothing(cHMIPLC) Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("PKS", "1"), enumExceptionType.Crash)
            Return False
        End If
    ...
    Public Overrides Function GetYValue() As Double
        SyncLock _Object
            Return cHMIPLC.ReadAny(lListInitParameter(0) + ".fdPLCRPosition", GetType(Single))
        End SyncLock
    End Function
...
Public Class StructPKS
    <MarshalAs(UnmanagedType.R4, SizeConst:=1)> Public fdHMIMoveXPosition As Single = 0
    <MarshalAs(UnmanagedType.R4, SizeConst:=1)> Public fdHMIMoveRPosition As Single = 0
    ...
    <MarshalAs(UnmanagedType.R4, SizeConst:=1)> Public fdHMIMoveRTolerance As Single = 0
    ...
    <MarshalAs(UnmanagedType.I1, SizeConst:=1)> Public fdPLCROriginDone As Boolean = False
    ...
    <MarshalAs(UnmanagedType.R4, SizeConst:=1)> Public fdPLCRPosition As Single = 0
