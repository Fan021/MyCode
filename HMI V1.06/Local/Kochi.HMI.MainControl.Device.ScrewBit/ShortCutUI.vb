...
Public Class ShortCutUI
    ...
    Public Const FormName As String = "ScrewBitShortCutUI"
    ...
    Public Function Quit(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object)) As Boolean Implements IShortcutUI.Quit
