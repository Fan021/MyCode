...
<clsHMIDeviceNameAttribute("ScrewXZ", "XYZ")>
Public Class clsScrewXZ
    Inherits clsHMIXZ
    ...
    Public Overrides Function Init(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object), ByVal lListInitParameter As List(Of String), ByVal lListControlParameter As List(Of String)) As Boolean
        ...
        If IsNothing(cHMIPLC) Then
            Throw New clsHMIException(cLanguageManager.GetUserTextLine("ScrewXZ", "3"), enumExceptionType.Crash)
            Return False
        End If
        ...
        Dim mTempValue As String = cIniHandler.ReadIniFile(cSystemManager.Settings.ConfigFolder + "\" + "ScrewXZ" + cDeviceCfg.StationID.ToString + "_" + cDeviceCfg.StationIndex.ToString + ".ini", "Configure", "HmiTextBox_AutoSpeed")
        If mTempValue = "" Then
            mTempValue = "10"
        End If
...
Public Class StructScrewXZ
    ...
    Public bulHMIScrew As StructScrewXZButton
    ...
    <MarshalAs(UnmanagedType.I1, SizeConst:=1)> Public bulHMISDUEnable1 As Boolean = False
    <MarshalAs(UnmanagedType.I1, SizeConst:=1)> Public bulHMISDUCalibrate1 As Boolean = False
    <MarshalAs(UnmanagedType.I1, SizeConst:=1)> Public bulHMISDUEnable2 As Boolean = False
    <MarshalAs(UnmanagedType.I1, SizeConst:=1)> Public bulHMISDUCalibrate2 As Boolean = False
    Public bulHMIMove As StructScrewXZButton
    Public bulHMIAxisXHome As StructScrewXZButton
    Public bulHMIAxisZHome As StructScrewXZButton
    Public bulHMIAxisXReset As StructScrewXZButton
    Public bulHMIAxisZReset As StructScrewXZButton
...
<StructLayout(LayoutKind.Sequential, Pack:=1)>
Public Structure StructScrewXZButton
