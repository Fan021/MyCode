...
Public Class ControlUI
    ...
    Private cObjectSource As clsTapeFeeder
    ...
    Public Function CloseIO(ByVal cLocalElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal cSystemElement As System.Collections.Generic.Dictionary(Of String, Object), ByVal lListInitParameter As System.Collections.Generic.List(Of String), ByVal lListControlParameter As System.Collections.Generic.List(Of String)) As Boolean Implements IControlUI.CloseIO
        ...
        Dim TempStructTOR As StructTOR = cHMIPLC.ReadAny(lListInitParameter(0), GetType(StructTOR))
        Dim NewTempStructTOR As New StructTOR
        NewTempStructTOR.HMI_TOR_OffDelay = TempStructTOR.HMI_TOR_OffDelay
        NewTempStructTOR.HMI_TOR_indexDelay = TempStructTOR.HMI_TOR_indexDelay
        If lListInitParameter.Count >= 1 Then cHMIPLC.WriteAny(lListInitParameter(0), NewTempStructTOR)
        Return True
    End Function
End Class