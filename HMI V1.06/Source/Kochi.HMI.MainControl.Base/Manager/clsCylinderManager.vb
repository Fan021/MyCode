    ...
    Public Function LoadData() As Boolean
        SyncLock _Object
            Try
                ...
                cIniHandler.OpenIniFile(cSystemManager.Settings.CylinderListConfig)
                For i = 1 To cMachineManager.MachineGlobalParameter.GetMachineGlobalParameterFromKey(clsHMIGlobalParameter.Cylinder_Max_Page)
                    Dim cIOPageCfg As New clsCylinderPageCfg(cSystemElement)
                    cIOPageCfg.ID = i.ToString
                    strTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Type")
                    cIOPageCfg.Text = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Text")
                    cIOPageCfg.Text2 = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Text2")
                    ...
                    For j = 1 To 8
                        ...
                        cIOCfg.TextA = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_TextA")
                        cIOCfg.TextA2 = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_TextA2")
                        cIOCfg.TextB = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_TextB")
                        cIOCfg.TextB2 = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_TextB2")
                        ...
                        cIOCfg.ReserveA = IIf(cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_ReserveA") = "True", True, False)
                        cIOCfg.ReserveB = IIf(cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_ReserveB") = "True", True, False)
                        cIOCfg.OneCylinder = IIf(cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_OneCylinder") = "False", False, True)
                        strTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_IOTriggerType")
                        If strTempValue <> "" Then cIOCfg.TriggerType = [Enum].Parse(GetType(enumIOTriggerType), strTempValue)
                        strTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_SensorAType")
                        If strTempValue <> "" Then cIOCfg.SensorAType = [Enum].Parse(GetType(enumIOType), strTempValue)
                        strTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_SensorBType")
                        If strTempValue <> "" Then cIOCfg.SensorBType = [Enum].Parse(GetType(enumIOType), strTempValue)
                        strTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_SensorAXIndex")
                        If strTempValue <> "" Then cIOCfg.SensorAXIndex = CInt(strTempValue)
                        strTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_SensorAYIndex")
                        If strTempValue <> "" Then cIOCfg.SensorAYIndex = CInt(strTempValue)
                        strTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_SensorBXIndex")
                        If strTempValue <> "" Then cIOCfg.SensorBXIndex = CInt(strTempValue)
                        strTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_SensorBYIndex")
                        ...
                        For k = 1 To 100
                            ...
                            Dim mTempValue As String = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_TypeNameA_" + k.ToString)
                            If mTempValue = "" Then Exit For
                            cIOLockCfg.TypeName = mTempValue
                            mTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_IndexXA_" + k.ToString)
                            If mTempValue = "" Then Exit For
                            cIOLockCfg.IndexX = mTempValue
                            mTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_IndexYA_" + k.ToString)
                            If mTempValue = "" Then Exit For
                            cIOLockCfg.IndexY = mTempValue
                            mTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_StatusA_" + k.ToString)
                            If mTempValue = "" Then Exit For
                        ...
                        For k = 1 To 100
                            Dim cIOLockCfg As New clsIOLockCfg
                            Dim mTempValue As String = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_TypeNameB_" + k.ToString)
                            If mTempValue = "" Then Exit For
                            cIOLockCfg.TypeName = mTempValue
                            mTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_IndexXB_" + k.ToString)
                            If mTempValue = "" Then Exit For
                            cIOLockCfg.IndexX = mTempValue
                            mTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_IndexYB_" + k.ToString)
                            If mTempValue = "" Then Exit For
                            cIOLockCfg.IndexY = mTempValue
                            mTempValue = cIniHandler.ReadIniFileFromOpenIni(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString, "Item" + "_" + j.ToString + "_StatusB_" + k.ToString)
                            If mTempValue = "" Then Exit For
                            cIOLockCfg.Status = mTempValue
        ...
        SyncLock _Object
            Try
                ...
                For i = cMachineManager.MachineGlobalParameter.GetMachineGlobalParameterFromKey(clsHMIGlobalParameter.Cylinder_Max_Page) + 1 To 100
                    cIniHandler.RemoveSection(cSystemManager.Settings.CylinderListConfig, "Page" + i.ToString)
                Next
                Return True
            Catch ex As Exception
                Throw New clsHMIException(ex, enumExceptionType.Crash)
        ...
        SyncLock _Object
            Try
                ...
                For Each element As clsCylinderPageCfg In lListPage.Values
                    ...
                    i = i + 1
                Next
                cIniHandler.SaveIniFile(cSystemManager.Settings.CylinderListConfig, lListValue)
                Return True
            Catch ex As Exception
                Throw New clsHMIException(ex, enumExceptionType.Crash)
                Return False
