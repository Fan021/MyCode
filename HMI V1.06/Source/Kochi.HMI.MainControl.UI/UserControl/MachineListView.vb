...
Public Class MachineListView
    ...
    Private Sub InitializeComponent()
        ...
        AddHandler Me.CellEnter, AddressOf ListView_CellEnter
    End Sub
    ...
    Public Sub ListView_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
        ...
        If lRowListValue.ContainsKey(Me.CurrentRow.Cells(1).Value.ToString) And e.ColumnIndex = 2 Then
            If lRowListValue(Me.CurrentRow.Cells(1).Value.ToString).ListValue.Count > 0 Then
                cComboBox.Items.Clear()
                Me.SetEditorControlPos(Me.cComboBox, e)
                For Each element As Object In lRowListValue(Me.CurrentRow.Cells(1).Value.ToString).ListValue
