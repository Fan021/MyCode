...
Public Class ChildrenErrorCodeListForm
    ...
    Public Function Init(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object)) As Boolean Implements IChildrenUI.Init
        Try
            ...
            InitForm()
            InitControlText()
            cLocalElement.Add(enumUIName.ChildrenErrorCodeListForm.ToString, Me)
            Timer_Show.Enabled = True
            Return True
        Catch ex As Exception
            cErrorMessageManager.AddHMIException(New clsHMIException(ex, enumExceptionType.Crash, enumUIName.ChildrenErrorCodeListForm.ToString))
            Return False
        End Try
    End Function
    ...
    Public Function InitControlText() As Boolean
        HmiLabel_Key.Label.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiLabel_Key")
        HmiLabel_Message.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiLabel_Message")
        HmiButton_Search.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiButton_Search")
        HmiButton_Cancel.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiButton_Cancel")
        HmiLabel_Function_ID.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiLabel_Function_ID")
        HmiLabel_Function_Key.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiLabel_Function_Key")
        HmiButton_Function_Add.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiButton_Function_Add")
        HmiButton_Function_Modify.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiButton_Function_Modify")
        HmiButton_Function_Del.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiButton_Function_Del")
        ...
        Else
            HmiLabel_Function_Message.Text = cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "HmiLabel_Function_Message3")
            HmiDataView_Data.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells
        End If
    ...
    Private Sub TextBox_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            ...
            Next
        Catch ex As Exception
            cErrorMessageManager.AddHMIException(New clsHMIException(ex, enumExceptionType.Alarm, enumUIName.ChildrenErrorCodeListForm.ToString))
        End Try
    End Sub
    ...
    Public Sub Add()
        Try
            ...
            If HmiTextBox_Function_Key.Text = "" Then
                cErrorMessageManager.AddHMIException(New clsHMIException(cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "1"), enumExceptionType.Alarm, enumUIName.ChildrenErrorCodeListForm.ToString))
                Return
            End If

            'If HmiTextBox_Function_Message.Text = "" Then
            '    cErrorMessageManager.AddHMIException(New clsHMIException(cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "2"), enumExceptionType.Alarm))
            '    Return
            'End If

            If cErrorCodeManager.HasErrorCode(HmiTextBox_Function_Key.Text) Then
                cErrorMessageManager.AddHMIException(New clsHMIException(cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "3", HmiTextBox_Function_Key.Text), enumExceptionType.Alarm, enumUIName.ChildrenErrorCodeListForm.ToString))
                Return
            End If
    ...
    Public Sub Modify()
        Try
            ...
            If HmiTextBox_Function_ID.Text = "" Then
                cErrorMessageManager.AddHMIException(New clsHMIException(cLanguageManager.GetTextLine(enumUIName.ChildrenErrorCodeListForm.ToString, "4"), enumExceptionType.Alarm, enumUIName.ChildrenErrorCodeListForm.ToString))
                Return
            End If
    ...
    Public Function Quit(ByVal cLocalElement As Dictionary(Of String, Object), ByVal cSystemElement As Dictionary(Of String, Object)) As Boolean Implements IChildrenUI.Quit
        cLocalElement.Remove(enumUIName.ChildrenErrorCodeListForm.ToString)
        cErrorMessageManager.Clean(enumUIName.ChildrenErrorCodeListForm.ToString)
        Me.Dispose()
        Return True
    End Function
