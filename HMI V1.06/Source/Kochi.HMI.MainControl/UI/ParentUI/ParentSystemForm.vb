        ...
        Try
            Select Case CType([Enum].Parse(GetType(enumHMI_LEFT_ITEM), strParentName), enumHMI_LEFT_ITEM)
                ...
                Case enumHMI_LEFT_ITEM.Statistics
                    ...
                    cListMainButtonElement.Add(New clsMainButtonManagerCfg(TableLayoutPanel_Right_Item, "Action", cLanguageManager.GetTextLine(enumUIName.ParentSystemForm.ToString, "Action Logging"), GetType(ChildrenActionForm)))
                ...
                Case enumHMI_LEFT_ITEM.System
                    cMainButtonManager.RegisterManager(Panel_Mid,
                                          ...
                                          New clsMainButtonManagerCfg(TableLayoutPanel_Right_Item, "GlobalProgram", cLanguageManager.GetTextLine(enumUIName.ParentSystemForm.ToString, "GlobalProgram"), GetType(ChildrenGlobalProgramForm)),
