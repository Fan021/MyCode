...
Public Class Count
    ...
    Private Sub DataGridView1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGridView1.Click
        If DataGridView1.CurrentRow.Index < DataGridView1.Rows.Count - 1 Then
            ...
            TextBox_Edit_Count.Text = DataGridView1.Rows(DataGridView1.CurrentRow.Index).Cells(2).Value
        End If
    End Sub
    ...
    Private Sub Button_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_Add.Click
        If TextBox_Edit_Article.Text = "" Then
            ...
            Return
        End If
        If TextBox_Edit_Count.Text = "" Then
            MessageBox.Show("Count is Null")
            Return
        End If
        If Not IsNumeric(TextBox_Edit_Count.Text) Then
            MessageBox.Show("Count is not Number")
            Return
        End If

        If Not Sql.GetCount(TextBox_Edit_Article.Text) Then
            MessageBox.Show("Article have existed")
            Return
        End If
        If Not Sql.InSertCount(TextBox_Edit_Article.Text, CInt(TextBox_Edit_Count.Text)) Then
    ...
    Private Sub Button_Modify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_Modify.Click
        ...
        If Sql.GetCount(TextBox_Edit_Id.Text, TextBox_Edit_Article.Text) Then
            MessageBox.Show("Article not existed")
            Return
        End If
        If Not Sql.UpdateCount(TextBox_Edit_Id.Text, TextBox_Edit_Article.Text, CInt(TextBox_Edit_Count.Text)) Then
    ...
    Private Sub Button_Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_Delete.Click
        ...
        If Not Sql.DelectCount(TextBox_Edit_Id.Text) Then
