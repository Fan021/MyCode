...
Public Class SMTNumber
    Private Setting As Settings
    Private Sql As SMTStore
    ...
    Private Sub SMTNumber_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Sql = New SMTStore
        Sql.Init(Setting)
        DisplayData()
    End Sub
    ...
    Private Function DisplayData() As Boolean
        ...
        ds = New DataSet
        If Sql.SelectToDataSet(TextBox_ID.Text, TextBox_SMT.Text, ds) Then
            dtInfo = ds.Tables(0)
            InitDataSet()
        Else
    ...
    Private Sub DataGridView1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGridView1.Click
        If DataGridView1.CurrentRow.Index < DataGridView1.Rows.Count - 1 Then
            ...
            TextBox_Edit_SMT.Text = DataGridView1.Rows(DataGridView1.CurrentRow.Index).Cells(1).Value
            TextBox_Edit_Article.Text = DataGridView1.Rows(DataGridView1.CurrentRow.Index).Cells(2).Value
        End If
    End Sub

    Private Sub Button_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_Add.Click
        If TextBox_Edit_SMT.Text = "" Then
            MessageBox.Show("SMT Number is Null")
            Return
        End If
        ...
        If Not Sql.GetArticle(TextBox_Edit_SMT.Text) Then
            MessageBox.Show("SMT Number have existed")
            Return
        End If
        If Not Sql.InsertSMTNumber(TextBox_Edit_SMT.Text, TextBox_Edit_Article.Text) Then
    ...
    Private Sub Button_Modify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_Modify.Click
        ...
        If Sql.GetArticle2(TextBox_Edit_Id.Text, TextBox_Edit_SMT.Text) Then
            MessageBox.Show("SMT Number not existed")
            Return
        End If
        If Not Sql.UpdateSMTNumber(TextBox_Edit_Id.Text, TextBox_Edit_SMT.Text, TextBox_Edit_Article.Text) Then
    ...
    Private Sub Button_Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_Delete.Click
        ...
        If Not Sql.DelectSMTNumber(TextBox_Edit_Id.Text) Then
