...
#End Region
    ...
    Public Sub New(ByVal SubStationCfg As SubStationCfg, ByVal i As Station, ByVal mSettings As Settings)
        ...
        _StatusDescription = ""
        _ArticleNumber = ""
        _CaqIniFile = _Settings.ConfigFolder & _SubStationCfg.Config
        If _SubStationCfg.Config = "" Or Not _FileHandler.FileExist(_CaqIniFile) Then
            ...
            Return
        End If
        'sResult = _FileHandler.ReadIniFile(_Settings.IniFolder, _Settings.ApplicationName, "CAQ", _i.IdString & "_CAQ_Disabled")
...
#End Region
    ...
    Public Sub New(ByVal SubStationCfg As SubStationCfg, ByVal MyStation As Station, ByVal mySettings As Settings, ByVal myLanguage As Language, ByVal Allstations As Dictionary(Of String, IStationTypeBase))


        MyBase.New(SubStationCfg, MyStation, mySettings)
        ...
        '        StationKey = _FileHandler.ReadIniFile(_Settings.IniFolder, _Settings.ApplicationName, "CAQ", _i.IdString + FpyName + Index.ToString)
    ...
    '            StationName = _FileHandler.ReadLanguageFile(_Settings.LngFolder, _Language.SelectedLanguageFileName, "CaqInfo", mKeys(mLoop))
    ...
    Private Sub GenerateData()
        ...
        _FailValInfo = _WtData.PartFailCode
