...
Public Class Shift
    ...
    Public _ListOfShiftElementData As New Dictionary(Of String, ShiftElementData)
    Public _ListOfShiftElement As New Dictionary(Of String, ShiftElement)
    Public _ListOfShiftElementCopy As New Dictionary(Of String, ShiftElement)
    ...
    Public Shared Name As String = "Shift"
        ...
        Try
            ...
            For i As Integer = 0 To _ListOfShiftElementData.Keys.Count - 1
                If i = 0 Then
                    ...
                    _ListOfShiftElementCopy.Add(_ListOfShiftElementCopy.Count.ToString, New ShiftElement(_ShiftName, Shift.DayStart, _ListOfShiftElementData(_ListOfShiftElementData.Keys(i)).ShiftData))
                End If
                If i > 0 And i <= _ListOfShiftElementData.Keys.Count - 1 Then
                    ...
                    _ListOfShiftElementCopy.Add(_ListOfShiftElementCopy.Count.ToString, New ShiftElement(_ShiftName, _ListOfShiftElementData(_ListOfShiftElementData.Keys(i - 1)).ShiftData, _ListOfShiftElementData(_ListOfShiftElementData.Keys(i)).ShiftData))
                End If
                If i = _ListOfShiftElementData.Keys.Count - 1 Then
                    ...
                    _ListOfShiftElementCopy.Add(_ListOfShiftElementCopy.Count.ToString.ToString, New ShiftElement(_ShiftName, _ListOfShiftElementData(_ListOfShiftElementData.Keys(i)).ShiftData, Shift.DayStop))
                End If
            Next
        Catch ex As Exception
            _Status = enum_ErrorCodes.SHIFT_ERROR_WINDOWS_ERROR
    ...
    Public Function ReturnCurrentShift() As Integer
        Try
            For Each Element As ShiftElement In _ListOfShiftElementCopy.Values
    ...
    Public Function UpdateShift() As Boolean
        RaiseEvent ShiftChange(ReturnCurrentShift())
        Return True
    End Function
    ...
    Public Overloads Function CheckRefWithNowTime(ByVal strRefTime As String, ByVal iCurrentShift As Integer) As Boolean
        ...
        Try
            ...
            For Each Element As ShiftElement In _ListOfShiftElement.Values
                ...
                If Element.ShiftTo = Shift.DayStop Then
                    If Element.NowDay < _ListOfShiftElement(_ListOfShiftElement.Keys(0)).ToWithNowday Then
                        If DateTime.Parse(strRefTime) >= Element.FromWithPreday And DateTime.Parse(strRefTime) <= Element.ToWithPreday And CInt(Element.ShiftName) = iCurrentShift Then
                            Return True
                        End If
                    Else
    ...
    Public Overloads Function CheckRefWithNowTime(ByVal iRefTime As DateTime, ByVal iCurrentShift As Integer) As Boolean
        ...
        Try
            For Each Element As ShiftElement In _ListOfShiftElement.Values
                ...
                If Element.ShiftTo = Shift.DayStop Then
                    If Element.NowDay < _ListOfShiftElement(_ListOfShiftElement.Keys(0)).ToWithNowday Then
                        If iRefTime >= Element.FromWithPreday And iRefTime <= Element.ToWithPreday And CInt(Element.ShiftName) = iCurrentShift Then
                            Return True
                        End If
                    Else
...
Public Class ShiftElement
    ...
    Public ReadOnly Property ToWithNowday As DateTime
        ...
        End Get
    End Property
    Public ReadOnly Property FromWithPreday As DateTime
        Get
            Return DateTime.Parse(_NowDay.AddDays(-1).ToString("yyyy.MM.dd") + " " + _ShiftFrom)
        End Get
    End Property
    Public ReadOnly Property ToWithPreday As DateTime
        Get
            Return DateTime.Parse(_NowDay.AddDays(-1).ToString("yyyy.MM.dd") + " " + _ShiftTo)
        End Get
    End Property
