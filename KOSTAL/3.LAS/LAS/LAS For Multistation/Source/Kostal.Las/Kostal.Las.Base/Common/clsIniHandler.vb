...
Public Class clsIniHandler
    ...
    Public Function OpenIniFile(ByVal strFileFullPath As String) As Boolean
        SyncLock _Object
            Try
    ...
    Public Function SaveIniFile(ByVal strFileFullPath As String, ByVal lListValue As List(Of String)) As Boolean
        SyncLock _Object
            Try
