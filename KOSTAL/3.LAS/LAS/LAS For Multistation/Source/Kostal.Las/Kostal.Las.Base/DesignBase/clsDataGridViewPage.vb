...
Public Class clsDataGridViewPage_Bosh
    Private _RowsPerPage As Integer
    Private _TotalPage As Integer
    Private _curPage As Integer = 0
    Private _DataGridView As System.Windows.Forms.DataGridView
    ...
    Public Function RegisterManager(ByVal datagridview As System.Windows.Forms.DataGridView, ByVal hmiDataViewPage As HMIDataViewPage) As Boolean
