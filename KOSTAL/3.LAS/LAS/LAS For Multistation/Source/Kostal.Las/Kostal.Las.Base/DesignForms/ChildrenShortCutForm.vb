...
Public Class ChildrenShortCutForm
    ...
    Public Function Init(ByVal Devices As Dictionary(Of String, Object), ByVal Stations As Dictionary(Of String, IStationTypeBase), ByVal _AppSettings As Settings) As Boolean
        ...
        cDebugButtonManager.Init(Devices, Stations, _AppSettings)
        GetPageMode()
        InitForm()
        InitControlText()
            ...
            Try
                ...
                Select Case iStep
                    Case 1
                        ...
                        Dim lListDI1() As Boolean = cHMIPLC.ReadAny(KostalAdsVariables.HMI_ShortcutButton, GetType(Boolean()), New Integer() {1 * 10})
                        For Each element As clsIOCfg In cDebugButtonManager.ListIO.Values
