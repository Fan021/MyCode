Public Class ReTestUI
    Implements IReTestUI
    Public ReadOnly Property Msg As System.Windows.Forms.Label Implements IReTestUI.Msg
        Get
            Return _Msg
        End Get
    End Property

    Public ReadOnly Property StepID As System.Windows.Forms.Label Implements IReTestUI.StepID
        Get
            Return _StepID
        End Get
    End Property

    Public ReadOnly Property Panel As System.Windows.Forms.Panel Implements IReTestUI.Panel
        Get
            Return DockPanel
        End Get
    End Property

    Public ReadOnly Property DataList As System.Windows.Forms.DataGridView Implements IReTestUI.DataList
        Get
            Return DG_ReTest
        End Get
    End Property
