...
Public Class OverallView
    ...
    Public Sub New()
        ...
        IOControl.Images(0) = My.Resources.gray
        IOControl.Images(1) = My.Resources.green
    ...
    Private Sub ShowStationView(ByVal W As Integer, ByVal H As Integer)
        Try
            ...
            Dim strBackImage As String = MySettings.ApplicationFolder + strStationPicture
            ...
            For Each cPictureCfg As clsPictureComponentCfg In lListStationView.Values
                Dim strStationBackImage As String = MySettings.ApplicationFolder + "Picture\green.png"
