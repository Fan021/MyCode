...
Partial Class ChildrenLoginForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.TableLayoutPanel_Body_Mid = New Kostal.Las.Base.HMITableLayoutPanel()
    ...
    Public WithEvents TableLayoutPanel_Body_Mid As HMITableLayoutPanel
    Public WithEvents Label_Title As System.Windows.Forms.Label
    Public WithEvents TableLayoutPanel_Body_Mid_UserName As System.Windows.Forms.TableLayoutPanel
    Public WithEvents Button_UserName As System.Windows.Forms.Button
    Public WithEvents TableLayoutPanel_Body_Mid_Password As System.Windows.Forms.TableLayoutPanel
    Public WithEvents Button_PassWord As System.Windows.Forms.Button
    Public WithEvents TableLayoutPanel1 As System.Windows.Forms.TableLayoutPanel
    Public WithEvents Button_Login As System.Windows.Forms.Button
    Public WithEvents Button_Cancel As System.Windows.Forms.Button
    Public WithEvents Panel_UserNane As System.Windows.Forms.Panel
    Public WithEvents Panel_PassWord As System.Windows.Forms.Panel
    Public WithEvents TextBox_PassWord As System.Windows.Forms.TextBox
    Public WithEvents Comobox_UserName As System.Windows.Forms.ComboBox
