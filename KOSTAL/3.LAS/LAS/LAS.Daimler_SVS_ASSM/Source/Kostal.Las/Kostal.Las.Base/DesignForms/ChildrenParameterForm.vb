...
Public Class ChildrenParameterForm
    ...
    Private Sub MachineListView_Data_CellValueChanged(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles MachineListView_Parameter.CellValueChanged
        ...
        End Try
    End Sub
    Private Sub MachineListView_Parameter_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles MachineListView_Parameter.CellClick
        If e.ColumnIndex < 0 Then Return
        MachineListView_Parameter.Cell_Enter(sender, e)
    End Sub
