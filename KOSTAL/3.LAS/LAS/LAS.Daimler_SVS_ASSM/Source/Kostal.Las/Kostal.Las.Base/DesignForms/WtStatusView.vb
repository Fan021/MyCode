...
#End Region
    ...
    Public Function Init(ByVal Devices As Dictionary(Of String, Object), ByVal Stations As Dictionary(Of String, IStationTypeBase)) As Boolean
        ...
        _PLCName = sResult
        _Log = New Logger(AppSettings)

        _i.Name = Me.Name.ToString

        mPassword.Init(_i, AppSettings, "UserPassWord")
        ...
        sResult = _xmlHandler.GetSectionInformation(AppSettings.ConfigFolder, AppSettings.ConfigName, "GeneralInformation", "WtStatus")
    ...
    Public Sub LanguageInit()
        ...
        ' _Language.ReadControlText(Me)
        Dim strText As String = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "Station:")
        ...
        Me.btnWtReset.Text = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "btnWtReset")
        Me.btnWtAbort.Text = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "btnWtAbort")
        Me.rbSource_WT.Text = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "rbSource_WT")
        Me.rbSource_Station.Text = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "rbSource_Station")

        Me.DG_WT_Data.Rows(0).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "Article")
        Me.DG_WT_Data.Rows(1).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "SerialNumber")
        Me.DG_WT_Data.Rows(2).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "Status")
        Me.DG_WT_Data.Rows(3).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "TargetAddress")
        Me.DG_WT_Data.Rows(4).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "Station")
        Me.DG_WT_Data.Rows(5).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "TestStepNumber")
        Me.DG_WT_Data.Rows(6).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "Code")
        Me.DG_WT_Data.Rows(7).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "Text")
        Me.DG_WT_Data.Rows(8).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "Value")
        Me.DG_WT_Data.Rows(9).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "LowerLimit")
        Me.DG_WT_Data.Rows(10).Cells(0).Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "UpperLimit")
