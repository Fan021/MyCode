Public Class CAQUI
    Implements ICAQUI
    Public ReadOnly Property Msg As System.Windows.Forms.Label Implements ICAQUI.Msg
        Get
            Return _Msg
        End Get
    End Property

    Public ReadOnly Property StepID As System.Windows.Forms.Label Implements ICAQUI.StepID
        Get
            Return _StepID
        End Get
    End Property

    Public ReadOnly Property Panel As System.Windows.Forms.Panel Implements ICAQUI.Panel
        Get
            Return DockPanel
        End Get
    End Property
    Public ReadOnly Property DataList As System.Windows.Forms.DataGridView Implements ICAQUI.DataList
        Get
            Return DG_FAIL
        End Get
    End Property
    ...
    Public Function AddRow(ByVal strSN As String, ByVal strArticle As String, ByVal strCustomer As String, ByVal strProductFamily As String, ByVal bResult As Boolean, ByVal strPartFailTestStep As String, ByVal strPartFailUnit As String, ByVal strPartFailValue As String, ByVal strPartFailUpperLimit As String, ByVal strPartFailLowerLimit As String, ByVal strPartFailText As String) As Boolean
        ...
        DG_FAIL.Rows(DG_FAIL.Rows.Count - 1).Cells("Result").Value = bResult.ToString
    ...
    Public Function AddColumns() As Boolean
        ...
        DG_FAIL.Columns.Add("Result", "Result")
