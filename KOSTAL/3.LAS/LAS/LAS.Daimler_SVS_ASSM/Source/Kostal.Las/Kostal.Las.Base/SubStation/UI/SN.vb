...
Public Class SNUI
    Implements ISNUI
    Public ReadOnly Property Msg As System.Windows.Forms.Label Implements ISNUI.Msg
        Get
            Return _Msg
        End Get
    End Property

    Public ReadOnly Property StepID As System.Windows.Forms.Label Implements ISNUI.StepID
        Get
            Return _StepID
        End Get
    End Property

    Public ReadOnly Property Panel As System.Windows.Forms.Panel Implements ISNUI.Panel
        Get
            Return DockPanel
        End Get
    End Property
    Public ReadOnly Property DataList As System.Windows.Forms.DataGridView Implements ISNUI.DataList
        Get
            Return DG_SN
        End Get
    End Property
