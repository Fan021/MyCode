...
Public Class PicManager
    ...
    Public Function Init(ByVal MyParent As Station, ByVal Inifile As String, ByVal _AppSettings As Settings, ByVal MyLanguage As Language) As Boolean
    ...
    Private Function Add() As Boolean
        ...
        For Each element As Dictionary(Of String, Object) In _XmlHandler.GetAnyListFromXml(AppSettings.ConfigFolder, _Inifile, "DisPlayScanners", "DisPlayScanner", New String() {"Name"})
            ...
            End If
        Next
        For Each element As Dictionary(Of String, Object) In _XmlHandler.GetAnyListFromXml(AppSettings.ConfigFolder, _Inifile, "Pictures", "Picture", New String() {"Name", "Folder", "PositionX", "PositionY", "Width", "Height", "Type", "CutEnable", "StartCutPointX", "StartCutPointY", "StopCutPointX", "StopCutPointY"})
    ...
    Public Overloads Function ShowPic(ByVal mArticle As String, ByVal mSN As String, ByVal mPicName() As String) As Boolean
        ...
        For i = 0 To ListPicture.Values.Count - 1
            ...
            If _FileHandler.FileExist(AppSettings.ApplicationFolder + tempPicElement.strFilePath + "\" + mPicName(i)) Then
                If tempPicElement.CutEnable Then
                    Dim img As Image = Image.FromFile(AppSettings.ApplicationFolder + tempPicElement.strFilePath + "\" + mPicName(i))
                ...
                End If
            Else
                tempPicElement.PictureBox.Image = Image.FromFile(AppSettings.PicFolder + "Error.jpg")
                tempPicElement.PictureBox.SizeMode = tempPicElement.Type
                tempPicElement.GroupBox.Location = New Point(tempPicElement.FilePositionX, tempPicElement.FilePositionY)
                tempPicElement.GroupBox.Size = New System.Drawing.Size(tempPicElement.FileWidth, tempPicElement.FileHeight)
                tempPicElement.GroupBox.Text = tempPicElement.strFileName + "  " + mArticle + "  " + mSN
    ...
    Private Sub ContextMenuStrip_Pic_ItemClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolStripItemClickedEventArgs) Handles ContextMenuStrip_Pic.ItemClicked
        ...
        Select Case e.ClickedItem.Name
            Case "ToolStripMenuItem_Open"
                OpenFileDialog_Pic.InitialDirectory = AppSettings.PicFolder
                If OpenFileDialog_Pic.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
    ...
    Private Sub UpdateValue()
        ...
        sResult = _XmlHandler.SetAnyListFromXml(AppSettings.ConfigFolder, _Inifile, _iCurrentPicIndex - 1, "Pictures", "Picture", New String() {"PositionX", "PositionY", "Width", "Height", "Type", "CutEnable", "StartCutPointX", "StartCutPointY", "StopCutPointX", "StopCutPointY"},
    ...
    Protected Function ReadDataFromXml(ByVal strSection As String, ByVal strKey As String, ByRef strValue As Integer) As Boolean
        Try
            sResult = _XmlHandler.GetSectionInformation(AppSettings.ConfigFolder, _Inifile, strSection, strKey)
