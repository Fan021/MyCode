...
Namespace Csv
    ...
    Public Class Condition
        ...
        Private _mapping As Mapping.Mapping
        ...
        ''' <remarks></remarks>
        Public Sub New(ByVal mapping As Mapping.Mapping, ByVal criterium As String)
            Me.Mapping = mapping
            Me.Criterium = criterium
        End Sub

        Public Sub New(ByVal mapping As Mapping.Mapping, ByVal regexCriterium As Regex)
            Me.Mapping = mapping
        ...
        ''' <remarks></remarks>
        Public Function IsMatch(ByVal csvRow As String()) As Boolean
            Dim result = Mapping.GetValue(csvRow)
