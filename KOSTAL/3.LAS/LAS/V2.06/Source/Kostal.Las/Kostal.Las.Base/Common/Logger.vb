...
Public Class Logger
    ...
    Public Sub New(ByVal _AppSettings As Settings)
    ...
    'Write Master Error in Logfile, send message to User and terminate the program
    Public Sub StackError(ByVal i As Station, Optional ByVal MessageBox As Boolean = False, Optional ByVal Messager As Messager = Nothing)
        SyncLock _Object
            LoggerOnlyTextLine(i, MessageBox, Messager)
    ...
    Public Overloads Sub Logger(ByVal i As Station, ByVal Messager As Messager, ByVal strText As String, ByVal strTextLine As String)
        SaveLogger(i, , Messager, strText, strTextLine)
    End Sub
    ...
    Public Overloads Sub Logger(ByVal i As Station, ByVal MessageBox As Boolean, ByVal strText As String)
        SaveLogger(i, MessageBox, , strText)
    End Sub
    ...
    Public Overloads Sub Logger(ByVal i As Station, ByVal MessageBox As Boolean, ByVal Messager As Messager, ByVal strText As String)
        SaveLogger(i, MessageBox, Messager, strText)
    End Sub
    ...
    Public Overloads Sub Logger(ByVal i As Station, ByVal MessageBox As Boolean, ByVal Messager As Messager, ByVal strText As String, ByVal strTextLine As String)
        SaveLogger(i, MessageBox, Messager, strText, strTextLine)
    End Sub

    Public Sub SaveLogger(ByVal i As Station, Optional ByVal MessageBox As Boolean = False, Optional ByVal Messager As Messager = Nothing, Optional ByVal strText As String = "", Optional ByVal strTextLine As String = "")
        SyncLock _Object
            Try
                Dim _Text As String
    ...
    Public Sub LoggerNoStepTextLine(ByVal i As Station, ByVal Messager As Messager, Optional ByVal strText As String = "", Optional ByVal strTextLine As String = "")
        ...
        End SyncLock
    End Sub
    Public Sub LoggerOnlyTextLine(ByVal i As Station, Optional ByVal MessageBox As Boolean = False, Optional ByVal Messager As Messager = Nothing)
        SyncLock _Object
            Dim _Text As String
    ...
    Public Overloads Sub ThrowerNoStation(ByVal i As Station, ByVal MessageBox As Boolean, ByVal Messager As Messager, ByVal strText As String)
