...
Public Class OverviewInformation
    ...
    Public Sub New(ByVal Devices As Dictionary(Of String, Object), ByVal Stations As Dictionary(Of String, IStationTypeBase), ByVal _AppSettings As Settings)

        _OverviewInfosDictionary = New Dictionary(Of String, StationInformation)


        Dim _FileHander As New FileHandler
        Dim s_FileName As String = _AppSettings.ConfigFolder + _AppSettings.ConfigName
