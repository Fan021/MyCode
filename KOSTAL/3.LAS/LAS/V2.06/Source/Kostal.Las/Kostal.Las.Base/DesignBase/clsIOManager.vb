    ...
    Public Function LoadData() As Boolean
        SyncLock _Object
            Try
                ...
                Dim strFileName As String = AppSettings.ConfigFolder + "IO.ini"
                ...
                sResult = mXmlHandler.GetSectionInformation(AppSettings.ConfigFolder, AppSettings.ConfigName, "GeneralInformation", "IO_Max_Page")
                If sResult = "" Then
                    sResult = "1"
                End If
                For i = 1 To CInt(sResult)
                    ...
                    If cIOPageCfg.IOType <> enumIOType.NONE Then
                        For j = 1 To 8
                            ...
                            cIOCfg.Text = cIniHandler.ReadIniFileFromOpenIni(strFileName, "Page" + i.ToString, "Item" + "_" + j.ToString + "_Text")
                            cIOCfg.Text2 = cIniHandler.ReadIniFileFromOpenIni(strFileName, "Page" + i.ToString, "Item" + "_" + j.ToString + "_Text2")
                            cIOCfg.AdsName = cIniHandler.ReadIniFileFromOpenIni(strFileName, "Page" + i.ToString, "Item" + "_" + j.ToString + "_AdsName")
                            cIOCfg.XIndex = lListTypeNumber(cIOPageCfg.IOType)
                            cIOCfg.YIndex = j.ToString
                            cIOCfg.Reserve = IIf(cIniHandler.ReadIniFileFromOpenIni(strFileName, "Page" + i.ToString, "Item" + "_" + j.ToString + "_Reserve") = "True", True, False)
                            ...
                            Select Case cIOCfg.PageType
                                Case enumIOType.EL1008
                                    ...
                                    cIOCfg.AdsName = KostalAdsVariables.HMI_EL1008
                                Case enumIOType.EP1008
                                    cIOCfg.IO = New InputIO
                                    cIOCfg.AdsName = KostalAdsVariables.HMI_EP1008
                                Case enumIOType.EL2008
                                    cIOCfg.IO = New OutputIO
                                    cIOCfg.AdsName = KostalAdsVariables.HMI_EL2008
                            End Select
                            For k = 1 To 100
                                Dim cIOLockCfg As New clsIOLockCfg
                                Dim mTempValue As String = cIniHandler.ReadIniFileFromOpenIni(strFileName, "Page" + i.ToString, "Item" + "_" + j.ToString + "_TypeName_" + k.ToString)
                                If mTempValue = "" Then Exit For
                                cIOLockCfg.TypeName = mTempValue
                                mTempValue = cIniHandler.ReadIniFileFromOpenIni(strFileName, "Page" + i.ToString, "Item" + "_" + j.ToString + "_IndexX_" + k.ToString)
                                If mTempValue = "" Then Exit For
                                cIOLockCfg.IndexX = mTempValue
                                mTempValue = cIniHandler.ReadIniFileFromOpenIni(strFileName, "Page" + i.ToString, "Item" + "_" + j.ToString + "_IndexY_" + k.ToString)
                                If mTempValue = "" Then Exit For
                                cIOLockCfg.IndexY = mTempValue
                                mTempValue = cIniHandler.ReadIniFileFromOpenIni(strFileName, "Page" + i.ToString, "Item" + "_" + j.ToString + "_Status_" + k.ToString)
                                If mTempValue = "" Then Exit For
                    ...
                    For Each element As clsIOCfg In lListPage(strID).ListIO.Values
                        ...
                        Select Case element.PageType
                            Case enumIOType.EL1008
                                ...
                                element.AdsName = KostalAdsVariables.HMI_EL1008
                                element.IO = New InputIO
                            Case enumIOType.EP1008
                                element.Text = "X" + (j - 1).ToString
                                element.Text2 = "X" + (j - 1).ToString
                                element.AdsName = KostalAdsVariables.HMI_EP1008
                                element.IO = New InputIO
                            Case enumIOType.EL2008
                                element.Text = "Y" + (j - 1).ToString
                                element.Text2 = "Y" + (j - 1).ToString
                                element.AdsName = KostalAdsVariables.HMI_EL2008
            ...
            Try
                ...
                For Each element As clsIOPageCfg In lListPage.Values
                    ...
                    If element.IOType <> enumIOType.NONE Then
                        ...
                        End If
                        If element.Text.IndexOf(element.IOType.ToString) >= 0 Then
                            ...
                            End If
                        End If
                        If element.Text2.IndexOf(element.IOType.ToString) >= 0 Then
                            Dim cValue() As String = element.Text.Split("_")
                            If cValue.Length = 1 Then
                                '  element.Text2 = element.Text
                            ElseIf cValue.Length > 1 Then
                                If IsNumeric(cValue(1)) Then
                                    element.Text2 = element.IOType.ToString + "_" + iCnt.ToString
                                End If
