...
'   Change CounterFolder to AppSettings.CounterFolder
...
Public Class ArticleCounter
    ...
    Public Function Init(ByVal MyParent As Station, ByVal _AppSettings As Settings, ByVal MyLanguage As Language) As Boolean
        ...
        _FileName_Data = _AppSettings.CounterFolder + AppSettings.ApplicationName + "_" + _i.IdString
    ...
    Public Sub LanguageInit()
        ...
        DG_Counter.Columns(_ARTICLE_COLUMN).HeaderCell.Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, Me.Name, "DG_Counter.Columns(" & Trim(CStr(_ARTICLE_COLUMN)) & ").HeaderCell")
        DG_Counter.Columns(_IN_WORK_COLUMN).HeaderCell.Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, Me.Name, "DG_Counter.Columns(" & Trim(CStr(_IN_WORK_COLUMN)) & ").HeaderCell")
        DG_Counter.Columns(_PASS_COLUMN).HeaderCell.Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, Me.Name, "DG_Counter.Columns(" & Trim(CStr(_PASS_COLUMN)) & ").HeaderCell")
        DG_Counter.Columns(_FAIL_COLUMN).HeaderCell.Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, Me.Name, "DG_Counter.Columns(" & Trim(CStr(_FAIL_COLUMN)) & ").HeaderCell")
        DG_Counter.Columns(_BUTTON_COLUMN).HeaderCell.Value = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, Me.Name, "DG_Counter.Columns(" & Trim(CStr(_BUTTON_COLUMN)) & ").HeaderCell")
        DG_Counter.ColumnHeadersDefaultCellStyle.Font = New Font("Calibri", 10)
        DG_Counter.AlternatingRowsDefaultCellStyle.Font = New Font("Calibri", 10)
        DG_Counter.RowsDefaultCellStyle.Font = New Font("Calibri", 10)
