...
#End Region
    ...
    Public Sub LanguageInit()
        ...
        Me.lblWtName.Text = _FileHandler.ReadLanguageFile(AppSettings.LngFolder, _Language.LanguageElement.SelectedLanguageFileName, "WtData", "lblWtName")
