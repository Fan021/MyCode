...
Public Class MES
    ...
    Protected Delegate Function dMesStartStamp(ByVal sSerialNumber As String) As enumMESStatus
    ...
    Public Overloads Sub MesStart(ByVal sSerialNumber As String)
        _MesStartStamp_RUN = True
        pMesStartStamp.BeginInvoke(sSerialNumber, pMesStartStampCB, Nothing)
    End Sub
    ...
    Protected Function _MesStartStamp(ByVal sSerialNumber As String) As enumMESStatus
        Dim INISection As String = String.Empty
        Dim INIFile As String = String.Empty
