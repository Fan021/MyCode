            ...
            Select Case _i.StepOutputNumber
                ...
                Case 6
                    If StationBase.ReadStructDeviceInteraction.bulAdsActionIsPass Then
                        _LocalArticle.ArticleElements(KostalArticleKeys.KEY_SERIAL_NUMBER).Data = StationBase.LocalArticle.ArticleElements(KostalArticleKeys.KEY_SERIAL_NUMBER).Data
