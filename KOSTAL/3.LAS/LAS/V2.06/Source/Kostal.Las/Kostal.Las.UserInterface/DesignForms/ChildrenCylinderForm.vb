...
Public Class ChildrenCylinderForm
    ...
    Private Sub MainButton_Click(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs)
        Try
            If e.Button = MouseButtons.Right Then
                ...
                cParameter.Init(Devices, Stations, MySettings)
            ...
            If e.Button = MouseButtons.Left Then
                ...
                If strTempName.Split(CChar("."))(1) = "A" Then
                    strTempName = strTempName.Split(CChar("."))(0)
                    Dim sResult As String = mXmlHandler.GetSectionInformation(MySettings.ConfigFolder, MySettings.ApplicationName, "GeneralInformation", "Cylinder_Max_Page")
                    If sResult = "" Then
                        sResult = "1"
                    End If
    ...
    Private Sub RefreshUI()
        ...
        While Not bExit
            Try
                ...
                Select Case iStep
                    Case 1
                        sResult = mXmlHandler.GetSectionInformation(MySettings.ConfigFolder, MySettings.ApplicationName, "GeneralInformation", "Cylinder_Max_Page")
                        If sResult = "" Then
                            sResult = "1"
                        End If
                        ResetIO()
    ...
    Public Sub ResetIO()
        ...
        If Not IsNothing(cHMIPLC) Then cHMIPLC.WriteAny(KostalAdsVariables.HMI_Cylinder, cDefaultValue)
