...
Partial Class ChildrenUserForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.HmiLabel_Name = New Kostal.Las.UserInterface.HMILabel()
        Me.HmiTextBox_Name = New Kostal.Las.UserInterface.HMITextBox()
        Me.HmiLabel_Level = New Kostal.Las.UserInterface.HMILabel()
        Me.HmiButton_Search = New Kostal.Las.UserInterface.HMIButton()
        Me.HmiButton_Cancel = New Kostal.Las.UserInterface.HMIButton()
        Me.HmiComboBox_Level = New Kostal.Las.UserInterface.HMIComboBox()
        ...
        Me.HmiComboBox_Function_Level = New Kostal.Las.UserInterface.HMIComboBox()
        Me.HmiLabel_Function_Level = New Kostal.Las.UserInterface.HMILabel()
        ...
        Me.HmiTextBox_Function_Password = New Kostal.Las.UserInterface.HMITextBox()
        Me.HmiTextBox_Function_Name = New Kostal.Las.UserInterface.HMITextBox()
        Me.HmiLabel_Function_Password = New Kostal.Las.UserInterface.HMILabel()
        Me.HmiLabel_Function_Name = New Kostal.Las.UserInterface.HMILabel()
